...
# ★[9/21] R2 16:30 → 17:40 — 보고서 본체가 클라우드 C3(17:00)로 가고 R2는 배달부가 됐다. 작업 스케줄러는
#   17:40으로 바뀌었는데 이 표만 16:30에 남아 **매일 '지각 70분 — 절전/전원 확인' 거짓 경고**를 냈다(9/21 로그 실측).
$SchedMap = @{ r1='10:00'; r2='17:40'; r3='09:00'; r4a='20:00'; r4b='21:15'; r4c='02:30' }
