...
- 매수 = **낙폭 사다리**: 고점대비 낙폭으로 해금(D1 -25%:15% … D4 -55%:25%)하고 **회복하면 다시 잠긴다(RESET·매일 재계산)**. S&P500 폭풍 ≥70%ile이면 **전면 정지**(하드플로어). 상한 정본 = `tranche_rules.py`. ⚠️ 舊 "코스피 7,500 하회 시 전면 동결" 안전핀은 **7/30 폐기** — 이 줄이 7주간 폐기된 룰을 현행처럼 적고 있었다(8/23 수정).
