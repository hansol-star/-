...
window.APP_DATA = {
  "generated_at": "2026-06-27 23:59 KST",
  ...
  "totals": {
    "assets_krw": 7950734,
    "stocks_value_krw": 7325963,
    "cash_krw": 624771,
    "day_change_krw": -36386,
    "day_change_pct": -0.49,
    "total_pnl_krw": 46853,
    "total_pnl_pct": 0.64
  },
  ...
  "holdings": [
    ...
    },
    {
      ...
      "target": "$312.72 (+7.4%)",
      "buy_zone": "목표근접",
      "trim": "트림 1순위 후보 (정수 1주 강세 지정가→GOOGL)",
      "forecast": {
        "week": {
          "low": 288,
          "high": 309,
      ...
      "comment": "🔴 MANGOS 제외(AI낙오). 6/26 +3.14%($283.78·원가比 +10.4%) 반등=트림 창. 재무압도(2Q26 매출 $111.2B+17%·서비스 사상최대·GM 49.3%·바이백 $1,000억 추가) vs 글라스 2027말 연기·Siri 지연. 13F 버크셔 2년 -74%(잔여 1위 22%)+알파벳 신규편입. 정수 1주 강세 지정가 트림→GOOGL 재배치 베이킹(미집행), 1주+분수 글라스 콜옵션 유지. 7/30 FY Q3 재판단. 패닉셀 금지.",
      "issues": [
        {
          "date": "2026-06-27",
          "tag": "검증",
  ...
  "orders": [
    {
      ...
      "amount_usd": 312,
      "date": "2026-06-27",
      "note": "베이킹(자동 아님·정훈 폰창 결정). 6/26 +3.14%($283.78·원가比 +10.4%) 반등=트림 창. -6% 딥 투매 금지, 목표 $312.72 권역 강세 지정가 사다리($290·$305·$312 분할). 매도분→GOOGL 소수점 적립(MANGOS 'G'+Anthropic 우회로·재배치 1순위). 잔여 1주+분수(0.022472)=글라스(2027말)·피지컬AI 콜옵션 유지(전량청산 금지). 13F 버크셔 애플 -74%+알파벳 신규편입 정합. 7/30 FY Q3가 가격탄력성 검증대→잔여 재판단. portfolio.json 미변경(미집행)."
    },
    {
      "id": "o-naver-1",
      "label": "NAVER",
