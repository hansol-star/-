...
window.APP_DATA = {
  "generated_at": "2026-06-25 16:40 KST",
  "as_of": "2026-06-25 17:35 KST (국장 종가·폰창 집행 지시서 addendum) · 워치 스코어 0~100 채점 도입(시스템 개선)",
  ...
  "totals": {
    "assets_krw": 8009704,
    "stocks_value_krw": 7384933,
    "cash_krw": 624771,
    "day_change_krw": -111272,
    "day_change_pct": -1.48,
    "total_pnl_krw": 105823,
    "total_pnl_pct": 1.45
  },
  "safety": {
    "pin": 7500,
  ...
  "outlook": [
    {
      ...
      "tag": "지수급등·외인미복귀·관망",
      "dir": "↑",
      "text": "🚀코스피 +5.42%(8,930.30·장중 9,044·매수 사이드카) 하지만 🔴외인 -8,355억 순매도 5거래일 연속(기관 +3.3조 단독 견인·개인 -2.5조). 급등은 MU 어닝서프發 SK하이닉스 +13.06%·삼성 +5.29% 반도체 단독 쏠림일 뿐 '강세 복귀 스위치'(외인 전환) 미점등. 코스닥 -2.36% 역주행. ★폰창 집행=양 블록 모두 관망: (A)국내 시간외 17:30~18:00 신규 매수·매도 없음(삼성 추격금지·NAVER 존 -11.2% 아래+외인매도 보류·두산E 10만 미달) (B)미국 예약=신규 0(외인 미복귀+오늘밤 PCE 폰미가용→베이킹). 보유 16 전량 홀딩. MU 절반차익은 6/24밤 체결 확정(토스 스크린샷·+43.6%·0.04→0.020001주). 오늘 17:30 폰창 미국 신규 예약 0건. 안전핀 7,500 버퍼 +19.1%."
    },
    {
      "horizon": "내일 (6/26 금)",
      "tag": "PCE소폭매파·관망",
      "dir": "→",
      "text": "★美 5월 코어 PCE 결과 확정(6/25 21:30): 코어 3.4% YoY(컨센 3.3%·소폭상회·2023.10 이후 최고)·헤드라인 4.1%(부합·2023.4 이후 최고). '인라인~소폭매파'로 노컷·9월 인상 68% 내러티브 유지·DXY 견조→원화 약세 압력. 미장 개장초 AI/capex 약세(AAPL -4.58% 맥북·아이패드 가격인상·NVDA·MSFT·ORCL 음봉) vs MU +9.64% 차별화. 6/26 국장 09:00은 밤사이 美 약세+PCE 매파 반영 갭다운 경계, 8,000 사수 확인. 폰창은 저녁 17:30~20:50뿐(아침 없음). SPCX MSCI 편입 메커닉·美 주간 신규실업청구. ★폰창 예약후보 전부 조건부 관망: NAVER 정수1주(존 -11.2% 아래·외인전환 확인시만)·MU잔여 무액션홀딩·삼성 추격금지·빅테크3차(META·AVGO) PCE매파로 동결유지·AAPL 트림1순위지만 -4.58%+분수주 실효낮아 무액션."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간",
  ...
  "index_forecast": [
    ...
    },
    {
      ...
      "high": 26400,
      "dir": "→",
      "note": "6/25 개장초 -0.8%(AAPL -4.58% 맥북·아이패드 가격인상 견인·NVDA -2.49%·MSFT -2.06%·ORCL -3.39% AI/capex 약세) vs MU +9.64% 차별화. PCE 코어 3.4%(소폭상회)로 매파 부담. 다우 +0.76% 밸류 로테이션·SOX +0.3%."
    },
    {
      "name": "S&P500",
      "ref": 7358.22,
      ...
      "high": 7500,
      "dir": "→",
      "note": "6/25 개장초 보합(+0.01%). 초반 MU 비트+PCE 부합 기대로 상승하다 AAPL -4.58%·빅테크 약세에 반납. 코어 PCE 3.4% 소폭상회=노컷 매파 유지. 다우 밸류 강세로 지수 방어."
    },
    {
      "name": "필라델피아반도체",
      "ref": 13458,
