...
window.APP_DATA = {
  "generated_at": "2026-06-25 13:35 KST",
  "as_of": "2026-06-25 17:35 KST (국장 종가·폰창 집행 지시서 addendum)",
  "source_report": "docs/reports/report_v31_2026-06-25.md",
  "offline": false,
  "fx": {
    "usdkrw": 1539.85
  },
  "totals": {
    "assets_krw": 8090782,
    "stocks_value_krw": 7466011,
    "cash_krw": 624771,
    "day_change_krw": -22958,
    "day_change_pct": -0.31,
    "total_pnl_krw": 186901,
    "total_pnl_pct": 2.57
  },
  "safety": {
    "pin": 7500,
  ...
  "holdings": [
    ...
    },
    {
      ...
      "comment": "Cloud·Gemini, 반독점 노이즈. Cloud +63%·백로그 $460B. 6/22 −10% 충격 후 안정($346.13 −0.98%)=센티먼트, 펀더 무손상 코어홀딩. 캐펙스 $190B에도 클라우드 수익화 입증 1순위.",
      "issues": [
        {
          "date": "2026-06-24",
          "tag": "검증",
    ...
    },
    {
      ...
      "stars": 5,
      "score": 99,
      "target": "$1,200~1,750 (Susquehanna $1,750·UBS $1,625·Citi $1,200·MS $1,050·골드만 중립, 6/24 실적 후 일제 상향)",
      "buy_zone": "6/25 실적(목 새벽)",
      "trim": "절반차익 예약 체결확인(17:30 토스). 비트라 잔여 절반 홀딩",
      "forecast": {
        "week": {
          "low": 1040,
          "high": 1260,
      ...
      "comment": "★FQ3 대박 비트&레이즈 — 매출 $41.5B(컨센 ~$35B)·EPS $25.11·GM 84.9% 사상최고·Q4 가이던스 $50B/EPS $31·HBM4 2배 램프·2026 HBM 완판·선수금 $22B·$100B 계약. 시간외 +13%(→~$1,186). sell-the-news 아닌 펀더 비트=잔여 홀딩 정답.",
      "issues": [
        {
          "date": "2026-06-25",
          "tag": "검증",
  ...
  "hunter": {
    ...
    "updated": "2026-06-25",
    "source": "docs/reports/report_v31_2026-06-25.md",
    "channel_note": "테마·방향성은 빠르고 유용(로봇·AI전력·종전 등 선제 포착). 단 구체 수치는 자막오류·과장 잦음 → 방향성은 채택하되 숫자는 교차검증. 트랙레코드 개선세. ✅6/23 신규 11편 전량 자막확보(봇차단 없음). 검은화요일 폭락원인·MU 프리뷰 편은 방향성·목표가·MU컨센 정밀(드물게 숫자 양호) — 과소(외인 5천억)·과장(삼성+SK 합산 영익 150조) 2곳만. 우수 구간 지속.",
    "headline": "★MU FQ3 대박 비트&레이즈(매출 $41.5B·EPS $25.11·GM 84.9% 사상최고·Q4 $50B·HBM4 2배 램프·2026 HBM 완판·시간외 +13%) → 메모리 슈퍼사이클 검증·삼성/하닉 6/25 갭업 호재. BUT 외인 4거래일 연속 순매도(누적 11.76조)로 6/24 +3.26% 반등은 데드캣(외인 미복귀). 경제사냥꾼 6/24: 빚투 38.5조 청산 경계(룰1·5 외부검증)·호남 반도체 인프라 수혜(원익IPS 호명·착공 전 추격금지)·삼성 90조 자사주(소각 아닌 보상). 오늘밤 21:30 코어 PCE(컨센 3.3% YoY).",
    "latest_videos": [
      {
        "id": "b빚투-청산-0624",
        "date": "2026-06-24",
        ...
        "summary": "1만 가는 길 급락은 구조적으로 반복 → 신용(빚투) 계좌가 반대매매로 청산당해 개인만 영구퇴장. 코어 장기보유 vs 레버리지 추격을 칼같이 구분하라 = 정훈 룰1(코스피 7,500 동결)·룰5(레버리지 미사용) 외부검증. KOSPI 6/22 ~9,114 사상최고→6/23 −9.99% 8,203.84 서킷 검증.",
        "points": [
          "KOSPI 6/22 ~9,114→6/23 −9.99%(910.71p) 8,203.84 서킷[검증]",
          "신용잔고 38.5조 역대최대[미확인, 방향성 타당]",
          "6/24 반등 '외인 순매도 지속·개인+기관 받아냄' 방향[검증]이나 자막 '수천억'은 자릿수 오류→실제 외인 −4~5조[정정]",
          "우리 확정 6/24 종가 8,471.02(+3.26%)"
        ],
        "caveats": [
          "6/24 외인 순매도 magnitude 자막 과소(수천억 vs 실제 4~5조)",
          "신용 38.5조는 미교차검증"
        ],
        "link": "https://www.youtube.com/watch?v=9n9usdXS6Vs"
      },
      {
        "id": "호남-반도체-인프라-0624",
        "date": "2026-06-24",
        "title": "삼성·하닉 호남 반도체 공장 수혜주",
        "tag": "검증·미확인",
        "tickers": [
          "005930.KS",
          "000660.KS",
        ...
        "summary": "호남 신규 팹=용인 이전 아닌 추가 신설(7~8년·수백조). 주인(삼성·하닉)보다 인프라(전선·ESS·초순수·건설·소부장)가 꾸준히 돈. 김용범 '논의 마무리 단계·용인 유지' 검증(6/29 민관합동회의 발표 예정). 발표≠착공 → 착공·발주 시점에 매출=룰3 추격금지 동일논리.",
        "points": [
          "김용범 호남 반도체 '논의 마무리 단계, 용인 유지'[검증](6/29 발표)",
          "거론 수혜주 LS일렉·HD현대일렉·효성중공업·원익IPS·PSK 등[미확인](채널도 '사라는 게 아니다' 명시)",
          "'발표≠착공, 착공·발주에야 인프라사 매출'[검증]=룰3"
        ],
        "caveats": [
          "거론 종목 단정 아님·테마 연결만",
          "6/29 발표 소문 추격금지(원익IPS)"
        ],
        "link": "https://www.youtube.com/watch?v=cIEUdJTOI0Y"
      },
      {
        "id": "삼성-90조-자사주-0624",
        "date": "2026-06-24",
        "title": "삼성전자 90조 자사주 매입",
        "tag": "검증",
        "tickers": [
          "005930.KS"
        ],
        "summary": "3년 분할 90조 자사주(특별성과급 ~68조+PSU ~22조 재원·약 2.9억주·2년 락업·이르면 다음달 시작) → 유통물량 축소. 삼성 시총1위 탈환 확인. 단 소각 아닌 보상용 → 순수 EPS 부양효과 제한적(채널도 명시).",
        "points": [
          "3년 분할 ~2.9억주·특별성과급 ~68조+PSU ~22조[검증, 서울신문·FN]",
          "삼성 시총1위 탈환[검증]",
          "소각 아닌 보상용→EPS 부양 제한적[검증]",
          "'2024년 발표 후 +68%' 수치는 자막 깨짐[미확인]"
        ],
        "caveats": [
          "소각 아닌 보상용 — 유통물량 축소 효과는 락업 기간 한정"
        ],
        "link": "https://www.youtube.com/watch?v=QTpwZ2JNuqE"
      },
      {
        "id": "spacex-63억-계약-0624",
        "date": "2026-06-24",
        "title": "스페이스X 63억달러 계약·제2의 엔비디아",
        "tag": "미확인",
        "tickers": [
          "SPCX",
          "MU"
        ],
        "summary": "SpaceX 콜로서스가 Reflection AI에 최대 $6.3B(2029) 컴퓨팅 임대·외부수주 $700억대→HBM 중장기 수요(하닉·삼성·MU). 수치 미교차검증, HBM 연결 방향성만 타당. SPCX 목표 $60~300 극단분산=룰3 추격금지.",
        "points": [
          "Reflection AI/콜로서스 $6.3B 계약[미확인]",
          "HBM 수요 연결(하닉·삼성·MU)[방향성 타당]",
          "SPCX 목표 $60~300 극단분산[채널도 리스크 명시]"
        ],
        "caveats": [
          "계약 구체수치 미교차검증",
          "SPCX 추격금지(급등주)"
        ],
        "link": "https://www.youtube.com/watch?v=wp6_EqW7F9E"
      },
      {
        "id": "crash-3reasons-0623",
        "date": "2026-06-23",
        "title": "오늘 코스피가 역대급 '폭락했던' 진짜 이유",
        "tag": "검증·정정2",
        "tickers": [
          "005930.KS",
          "000660.KS",
        ...
        "summary": "검은화요일(코스피 −9.99%·역대최대낙폭·서킷브레이커) = 3대 악재 동시 폭발: ⓐ美 빅테크 AI 핵심인재 이탈(구글→오픈AI/앤트로픽)로 AI 자본수익성 의구심, ⓑ금리(BofA 9·10·12월 3회 인상 전망), ⓒ국내 미실현이익 과세 논의 → 주도주(반도체) 차익실현 장세. 처방: '반도체 끝 아님, MU 실적 후 HBM 수요·외인 매도 멈춤 확인하라'(정훈 역발상 룰 정합). 조회 311,465 압도적 1위.",
        "points": [
          "AI 인재이탈[검증]: Noam Shazeer(Gemini)→OpenAI·John Jumper(노벨·AlphaFold)→Anthropic, 알파벳 6/22 −7%·시총 ~$250B 증발",
          "채널 '알파벳 −5%·$2,250억 증발'[정정] → 실제 −7%·$250B(채널 과소)",
          "BofA 금리[검증]: 9·10·12월 각 25bp 3회 인상→4.50%, 2028까지 인하 없음",
          "미실현이익 과세[미확인]: 국회 토론회 발언 수준·정책 미확정",
          "채널 '외인 5천억 던짐'[정정] → KRX 확정 외인 −5.79조·기관 −5.49조 동반(조 단위·기관도 큼)",
          "SK하이닉스 −12.47%(300만→255만)·삼성 −12.31%[검증]"
        ],
        "caveats": [
          "외인 순매도 규모 자막 과소(5천억 vs 실제 5.79조)",
          "미실현이익 과세는 정책 미확정 — 방향성만",
          "안전핀 코스피 7,500까지 약 8.6% 거리(리스크 데스크 트리거)"
        ],
        "link": "https://www.youtube.com/watch?v=GxEsvOhrIdc"
      },
      {
        "id": "spacex-risk-0623",
        "date": "2026-06-23",
        "title": "SpaceX 역대급 악재 터졌다",
        "tag": "검증",
        "tickers": [
          "SPCX"
        ],
        "summary": "SpaceX 상장 하루 전 악재 — MSCI ESG 최저등급 CCC(6/21, 거버넌스 우려)·$200억 채권조달·상장후 최저가·머스크 의결권 85%. 우주 ETF 고가편입 손실(TIGER미국우주테크 한달 반토막). 스토리 과열·지배구조 리스크 경고 = 룰3(SPCX 추격금지) 보강.",
        "points": [
          "MSCI ESG 최저 CCC(6/21, 거버넌스)[검증]",
          "$200억 채권조달·상장후 최저·주간 −19.7%[검증]",
          "머스크 의결권 85%·우주ETF 손실[검증]"
        ],
        "caveats": [
          "추격금지 대상(고변동·지배구조 리스크)"
        ],
        "link": "https://www.youtube.com/watch?v=6R5UcLKo_4w"
      },
      {
        "id": "kosdaq-reform-0623pm",
        "date": "2026-06-23",
        "title": "지금 '코스닥' 주식들이 계속 '하락장'인 진짜 이유",
        "tag": "검증·정정0",
        "tickers": [
          "240810.KQ",
          "005930.KS"
        ],
        "summary": "코스닥 부진 본질='주식수 게임'(유증·CB·물적분할 희석, 20년 시총 8.6배인데 지수 1.6배). 7/1 상폐요건 강화(시총 200억·동전주 퇴출)+코스닥 승강제(프리미엄/스탠다드/관리, 1군 반도체 28.5→50%, 7/1 30주년 발표·세부 9말~10초) → 일본 TSE 선례(니케이 +37%·외인 31.8%, 단 1군만 잔치=양극화). 원익IPS가 코스닥 1군 반도체 소부장 수혜주로 직접 거론.",
        "points": [
          "7/1 상폐요건: 시총 200억(내년 300억)·동전주 1000원 퇴출, 올해 상폐 ~150곳·경계 207곳(11.8%)[검증]",
          "코스닥 승강제 1군 반도체 비중 28.5%→50%, 7/1 30주년 발표·세부 9말~10초[검증]",
          "일본 TSE 2022 재편: 니케이 +37%·외인 31.8% 사상최고, 1군 양극화[검증]",
          "SK하이닉스 6/22 시총 2080조>삼성 2066조(25년7개월만 역전)→6/23 재역전[검증]",
          "코스닥 시총 20년 8.6배·지수 1.6배(희석)·NH 코스닥 목표 1,300[미확인, 방향성만]"
        ],
        "caveats": [
          "8.6배/1.6배·NH 1,300 자동자막 단정 수치 → 방향성만 채택",
          "Trump 양자 EO·美뉴스3 쇼츠 2편은 봇차단 미분석"
        ],
        "link": "https://www.youtube.com/watch?v=gtDLCOXysMc"
      },
      {
        "id": "mu-earnings-rally-0623",
        "date": "2026-06-23",
        "title": "월가에서 '마이크론' 실적 발표로 역대급 상승장 올 수 있다는 이유",
        "tag": "검증·일부정정",
        "tickers": [
          "MU",
          "005930.KS",
        ...
        "summary": "마이크론 실적이 삼전·하이닉스 7월 실적의 선행지표(바로미터). 발표 직후 '소문에 사 뉴스에 팔아라'식 단기 출렁임은 추세의 끝이 아니라 숨고르기 → 가이던스·총마진 확인 후 올라타라[검증, 룰3 정합]. MU 한국시간 6/25 새벽 발표.",
        "points": [
          "MU 실적 한국시간 6/25 새벽(현지 6/24 마감후)[검증]",
          "Needham $500→$1,550·Bernstein $510→$1,300 3배 상향[검증]",
          "EPS 컨센 채널 $20.76·YoY+987%→실제 ~$20.47·+972%[정정, 미세과장]",
          "매출 컨센 ~$34.5~34.8B[검증], 채널 '53조' 환산→실제 ~51조[정정]",
          "HBM 2026 완판·GM 81% 근접[검증]",
          "골드만 목표↑·의견 '중립' 유지[미확인]"
        ],
        "mentions": [
          "마이크론",
        ...
        "references": [
          "TradingKey(MU Q3 preview)",
          "Investing.com(Needham·Bernstein)"
        ],
        "caveats": "MU 6/25 새벽=폰 미가용·당일밤 대응 불가→사전 조건부룰만. 채널 EPS·환산 살짝 과장→검증치(EPS $20.47·매출 ~51조) 사용."
      },
      {
        "id": "kospi-crash-0623-reason",
        "date": "2026-06-23",
        "title": "오늘 코스피가 역대급 '폭락했던' 진짜 이유 (쇼츠)",
        "tag": "검증·미확인 혼재",
        "tickers": [
          "GOOGL",
          "MU",
        ...
        "summary": "6/23 코스피 −9.99% 폭락 = ①미 빅테크 AI 인재이탈(구글 Shazeer→OpenAI·Jumper→Anthropic, 알파벳 ~−7%·시총 ~$250B 증발)[검증] ②미 금리 인상 우려(BofA 9·10·12월 3회 인상 매파콜)[검증, 소수의견] ③국내 미실현이익 과세 거론(미확정)[미확인] 3중 동시 발생 → 주도주 반도체 차익실현.",
        "points": [
          "알파벳 6/22 ~−7%·시총 ~$250B 증발(채널 5%·2,250억은 보수적)[검증]",
          "Shazeer→OpenAI, Jumper(AlphaFold 노벨상)→Anthropic[검증]",
          "BofA 연준 2026 3회 인상(3.50~3.75%→4.25~4.50%)[검증, 매파 소수의견]",
          "하이닉스 장중 300만→250만대 ~12% 폭락[미확인, 종가 국장데스크 −12.47% 확정]",
          "미실현이익 과세 토론회 거론[미확인, 채널도 '확정 아님' 명시]"
        ],
        "mentions": [
          "알파벳/구글",
          "BofA",
        ...
        "caveats": "AI capex 회의론(인재이탈→'진짜 승자 맞나')이 AI 인프라 밸류 전반 압박=정훈 슈퍼사이클론 첫 실질 역풍. BofA 매파콜은 매크로 교차 필요. 과세는 워치만."
      },
      {
        "id": "samsung-hynix-leverage-etf-0623",
        "date": "2026-06-23",
        "title": "현정부가 '삼전·닉스 레버리지'를 없앨 수도 있다는 이유 (쇼츠)",
        "tag": "검증",
        "tickers": [
          "005930.KS",
          "000660.KS"
        ],
        "summary": "삼전·하이닉스 단일종목 2배 레버리지 ETF 개미 과열(보유자 92% 개인)→금감원 규제 시사. 폐지보다 신용·미수 조이기가 먼저[검증]. 레버리지는 음의 복리로 장기보유 부적합, 현물·분산이 합리적(정훈 룰4와 동일 방향).",
        "points": [
          "FSS 이찬진 원장 6/22 '드러누워서라도 막을 것'·신용/미수 단계 제한 검토[검증]",
          "단일종목 레버리지 ETF 회전율 평균 122.5%(현물 1% 미만)[검증]",
          "관련 자금 4조→14조·보유자 92% 개인[미확인, 급증·개인쏠림 방향성은 사실]",
          "신용융자 38조 사상최고[검증, 6/22 영상 재인용]"
        ],
        "mentions": [
          "금융감독원(이찬진)",
          "삼성전자",
        ...
        "caveats": "정훈 레버리지·신용 미사용(룰4)→직접 포지션 영향 없음. 단 레버리지 ETF 매물 출회 시 삼전·하이닉스 현물 변동성 확대 = 6/23 폭락과 연결 구조적 수급리스크."
      },
      {
        "id": "nps-55jo-real-reason",
        "date": "2026-06-22",
        "title": "국민연금이 코스피 9000에서 주식을 팔아치운 '진짜 이유'",
        "tag": "검증·일부정정",
        "tickers": [
          "005930.KS",
          "000660.KS"
        ],
        "summary": "NPS 7월 매도는 종목·증시 불신이 아니라 코스피 급등으로 국내주식 비중이 기준 초과→리밸런싱(기계적 비율맞추기)[검증]. 진짜 관건='NPS가 파느냐'가 아니라 그 물량을 외국인이 받아주느냐 vs 빚투(신용 38조) 개인이 마지막에 떠안느냐. 바클레이즈 7월부터 월 7~8조 매도 재개[검증]. 신용융자 38조 사상최고가 NPS보다 더 위험[검증, 반대매매 도미노].",
        "points": [
          "국내주식 목표비중 14.9→20.8% 상향·7월 적용[검증]",
          "바클레이즈 월 7~8조 매도·외인 올해 ~100조 순매도[검증, 리포트 정확]",
          "신용융자 ~38조 사상최고(작년말比 +10조)[검증]",
          "작년 국내주식 수익률 82.44%·119조 수익[정정→실제 35.12%·Q1+57조]",
          "현 국내주식 비중 ~30%·최대 55조 매도가능[미확인, 영상도 추정 면피]"
        ],
        "mentions": [
          "국민연금 기금운용위",
          "바클레이즈",
        ...
        "caveats": "결론('외인이 받아주냐가 분수령')은 정훈 트리거①과 동일. 7월 월7~8조=알려진 수급역풍(서프라이즈 아님)→추격금지 정합. 수익률 82.44%는 자막오류, 절대수치는 교차검증 후 채택."
      },
      {
        "id": "skhynix-adr-nasdaq",
        "date": "2026-06-22",
        "title": "시총 1위 찍은 SK하이닉스, 나스닥 상장하면 벌어질 일들",
        "tag": "검증·일부정정",
        "tickers": [
          "000660.KS",
          "MU",
        ...
        "summary": "SK하이닉스 6/22 종가 291.9만(+5.61%) 보통주 시총 2080조로 삼성(2066조) 26년만 추월[검증, 우선주합산 삼성 유지]. ADR=위로 엔진+아래 방아쇠 양날. HBM점유 SK61·MU22·삼성18[검증]. ADR 신주2.5%·최대40조·SEC 6/22주 관측·8월 나스닥. MU 6/25새벽 실적=메모리 풍향계[검증, 美6/24마감후 정확].",
        "points": [
          "보통주 시총 2080조 vs 삼성 2066조 25년7개월만 역전[검증]",
          "목표 430만 출처=한화투자(박준영)[정정, 채널 '하나투자' 오인]",
          "HBM SK61%/MU22%/삼성18% 카운터포인트와 일치[검증]",
          "코스피28%·레버ETF14조·개인92%[미확인]"
        ],
        "mentions": [
          "SK하이닉스",
          "MU",
        ...
        "caveats": "데이터센터 IP라 업로드 시각(분) 미확인, 본문 '6/22 장마감 기준' 인용으로 마감 후 업로드 확정. 목표가 출처 정정 필수."
      },
      {
        "id": "us-iran-war-summary",
        "date": "2026-06-22",
        "title": "미국vs이란 전쟁 총정리",
        "tag": "검증프레임·수치미확인",
        "tickers": [],
        "summary": "스위스 회담=종전 아닌 60일 임시MOU. 진짜 방아쇠=레바논·헤즈볼라(제3자 이스라엘). 본질=호르무즈↔달러 접근권 현금흐름 협상. 유가↑+원화약세=한국증시 악조합.",
        "points": [
          "60일 임시MOU·체크포인트 5개(브렌트80·환율·통행비용·제재면제·레바논)[검증프레임]",
          "브렌트 종가·배럴 수치 자막 혼선(600만/1700만)[미확인]"
        ],
        "mentions": [
          "유가",
          "원달러",
        ...
        "references": [],
        "caveats": "수치 자막오류 잦아 단정 회피, 방향성만 채택."
      },
      {
        "id": "us-china-3news-short",
        "date": "2026-06-22",
        "title": "쇼츠: 美+中 뉴스 3가지",
        "tag": "미확인",
        "tickers": [],
        "summary": "①호르무즈 통행재개·브렌트80 하회(②와 톤 반대) ②中 MP머티리얼즈 등 美희토류 수출통제 리스트 ③월러 연준이사 6/22 22시 연설('달러 역할'=금리발언 적을수도).",
        "points": [
          "中 희토류 대미 통제 구체건[미확인, 자막 고유명사 깨짐 가능]",
          "월러 연설 22시=폰 불가 시간대, 금리발언 적을 가능성[미확인]"
        ],
        "mentions": [
          "희토류",
          "월러",
        ...
        "references": [],
        "caveats": "희토류 관련주는 모멘텀성·추격금지(룰3)."
      },
      {
        "id": "nps-55tn-selloff-impact",
        "date": "2026-06-22",
        "title": "쇼츠: 국민연금 55조 매도폭탄이 코스피에 미치는 진짜 영향",
        "tag": "검증·일부정정",
        "tickers": [
          "005930.KS",
          "000660.KS"
        ],
        "summary": "7월 유예종료→기계적 매도 최대 55조. 관건=외인이 받아주냐(외인 복귀=흡수, 외인마저 돌아서면 대형주 위에서부터 붕괴). 정훈 트리거①(외인 재유입=강세 분수령)과 동일 프레임.",
        "points": [
          "7월 리밸런싱 재개·최대 55조[검증]",
          "목표비중 20.8% 맞으나 허용상단 ~26.8%(채널 '30%' 혼선)·현보유 ~30%가 문제[정정]",
          "바클레이즈 완충역할 소멸[미확인]"
        ],
        "mentions": [
          "국민연금",
        ...
        "caveats": "방향(초과→매도압력) 정확, 비율 디테일 채널 혼선."
      },
      {
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/25 목·종가 확정)",
      "tag": "지수급등·외인미복귀·관망",
      "dir": "↑",
      "text": "🚀코스피 +5.42%(8,930.30·장중 9,044·매수 사이드카) 하지만 🔴외인 -8,355억 순매도 5거래일 연속(기관 +3.3조 단독 견인·개인 -2.5조). 급등은 MU 어닝서프發 SK하이닉스 +13.06%·삼성 +5.29% 반도체 단독 쏠림일 뿐 '강세 복귀 스위치'(외인 전환) 미점등. 코스닥 -2.36% 역주행. ★폰창 집행=양 블록 모두 관망: (A)국내 시간외 17:30~18:00 신규 매수·매도 없음(삼성 추격금지·NAVER 존 -11.2% 아래+외인매도 보류·두산E 10만 미달) (B)미국 예약=신규 0(외인 미복귀+오늘밤 PCE 폰미가용→베이킹). 보유 16 전량 홀딩. MU 절반차익은 6/24밤 집행 추정(토스 키 없어 루틴서 체결 미확인). 안전핀 7,500 버퍼 +19.1%."
    },
    {
      "horizon": "내일 (6/26 금)",
      "tag": "PCE반영·관망",
      "dir": "→",
      "text": "오늘밤(6/25 21:30) 美 5월 코어 PCE(컨센 YoY 3.3%·헤드라인 4.1% 전망=2023.4 이후 최고) 결과 반영 갭. 오늘밤 폰 미가용(21:30은 가용창 밖)이라 6/26 저녁 폰창(17:30~20:50)서 대응 베이킹 — 아침 폰창은 없음. SPCX MSCI 편입 메커닉·美 주간 신규실업청구. MU 비트 후 삼성·하닉 추세 지속/식음 확인."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간",
      "dir": "→",
      "text": "검은화요일(6/23 −9.99%)→6/24 +3.26% 데드캣→★MU 대박 비트로 펀더 의구심 해소. 분수령 = 외인 순매수 재전환(강세 복귀 스위치·아직 미충족)·오늘밤 PCE. MU 비트가 '1일천하'(6/24 반등)에 펀더 연료를 댔으나 외인 미복귀가 상단 제약. 고환율 1,546·9월 인상 68%·점도표 3.8% 매파 역풍. 6/29 호남 반도체 민관합동회의 발표."
    },
    {
      "horizon": "이번달~7월",
      "tag": "관망·7월리스크",
      "dir": "→",
      "text": "3차 트랜치(META·AVGO) FOMC 매파로 보류 중(재개=비둘기 전환/META 7/29 실적/외인 복귀 중 하나). ⚠️7월 NPS 국내 리밸런싱=기계적 매도(대형주 매물집중)+신용 38.5조 역대최대 반대매매 리스크. 7/6 원달러 24시간 거래. 7/16 한은 금통위 2.50→2.75% 인상 전망. 체코 원전 7월 우선협상자(두산E). 7/22~ 美 2분기 실적시즌. 안전핀 코스피 7,500(6/25 종가 8,930 +19.1% 버퍼)."
    }
  ],
  "index_forecast": [
    {
      ...
      "high": 9200,
      "dir": "↗",
      "note": "6/25 +5.42%(8,930.30·장중 9,044 터치·매수 사이드카) MU發 반도체 단독 쏠림 급등. but 외인 5일 연속 순매도(-8,355억·누적 ~12.6조 추정)·기관 단독 견인이라 추세복귀 단정 금지. 외인 순매수 재전환 전까지 데드캣 경계. 9,000 안착 실패·코스닥 -2.36% 양극화. 안전핀 7,500 버퍼 +19.1%(미발동)·2차 8,000(+11.6%). 증권가 밴드 8,200~9,500."
    },
    {
      "name": "나스닥",
      "ref": 25476.6,
      ...
      "high": 26400,
      "dir": "→",
      "note": "6/24 −0.43% 보합 숨고르기. MU 비트로 AI 메모리 수요 검증(capex 회의론 일부 반박)이나 split 지속(MSFT −2.27%·ORCL −4.62% vs AVGO +0.51%). 오늘밤 PCE가 방향."
    },
    {
      "name": "S&P500",
      "ref": 7358.22,
      ...
      "high": 7500,
      "dir": "→",
      "note": "6/24 −0.10% 보합·다우 +0.35%(가치 로테이션). 셀오프 정지. 6/25 PCE 분수령(컨센 코어 3.3% YoY)."
    },
    {
      "name": "필라델피아반도체",
      "ref": 13458,
      ...
      "high": 14600,
      "dir": "↗",
      "note": "6/24 −0.18% 보합(Yahoo). ★MU 대박 비트&레이즈(시간외 +13%·HBM 완판·Q4 $50B)로 6/25 반도체 갭업 우위. 목표가 일제 상향($1,200~1,750). 단 외인 수급·PCE가 상단 변수."
    }
  ],
  "tasks": {
    "today": [
      {
        "id": "t-0625-4",
        "text": "✅ MU 절반차익 +43.6% 체결 확정(토스 스크린샷): 0.019999주 매도·순수령 $21.48·매도단가 ~$1,075(원가 $749). 보유 MU 0.04→0.020001주·cash_usd $1.11→$22.59. 잔여 절반은 비트&레이즈 업사이드 홀딩 — 플레이북대로 집행 완료(정훈이 할 일 끝남)",
        "done": true
      },
      {
        "id": "t-0625-3",
        "text": "🔕 오늘밤 21:30 美 5월 코어 PCE(컨센 3.3% YoY·헤드라인 4.1%)=폰 가용창(17:30~20:50) 밖이라 정훈이 할 건 없음(야간 반응매매 금지·이미 베이킹 완료). 결과는 6/26 저녁 폰창서 점검",
        "done": false
      }
    ],
    "week": [
      {
        "id": "t-w-1",
        "text": "★외인 순매수 재전환=강세 복귀 스위치 추적(현 4거래일 연속 순매도·누적 11.76조·미충족). MU 비트가 외인 매도 진정시키는지 6/25~26 확인",
        "done": false
      },
      {
        "id": "t-w-2",
        "text": "MU 비트 후 삼성·SK하이닉스 추세 지속 vs sell-the-news 식음 점검. 메모리/HBM 4종 집중도(신규 비중 추가 자제로 관리)",
        "done": false
      },
      {
        "id": "t-w-3",
        "text": "오늘밤 PCE 결과별(컨센/상회/하회) 9월 인상 확률·환율·코스피 6/26 갭 방향 사전 조건부룰",
        "done": false
      },
      {
        "id": "t-w-4",
        "text": "안전핀 코스피 7,500 모니터링(6/25 종가 8,930·버퍼 +19.1%) + 신용 38.5조·환율 1,546·9월 연준 인상확률 68% 추적",
        "done": false
      }
    ],
    "month": [
  ...
  "orders": [
    {
      ...
      "amount_krw": 199700,
      "date": "2026-06-25",
      "note": "1차 트랜치 보류 지속. 6/25 종가 199,700원(+0.15%)=매수존(225~235k) -11.2% 아래. 지수 +5.42% 급등에도 ★외인 5거래일 연속 순매도(6/25 -8,355억·미전환)+정리후보=보류 확정. 삼성은 +5.29% 추가상승으로 매수존 위 이탈(추격금지). 강세복귀 스위치=외인 순매수 재전환 확인 전까지 신규매수 보류. 7,500 하회=전면 동결."
    },
    {
      "id": "o-mu-trim-1",
      "label": "MU 절반차익",
