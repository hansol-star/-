...
window.APP_DATA = {
  "generated_at": "2026-06-30 08:41 KST",
  ...
  "totals": {
    "assets_krw": 8097522,
    "stocks_value_krw": 7472751,
    "cash_krw": 624771,
    "day_change_krw": 83798,
    "day_change_pct": 1.13,
    "total_pnl_krw": 193641,
    "total_pnl_pct": 2.66
  },
  "safety": {
    "pin": 7500,
    ...
    "latest_videos": [
      {
        ...
        "tag": "검증",
        "note": "74조 매도폭탄=코스피 9,000 가정 신영 추정 최대치(9,500→97.7조·1만→120.9조), 현 8,476이라 부담 작음 [검증]. 거래일 10→20일 분할·무차별 아닌 비중조정 교체매도(반도체 덜고 금융·소비재) [검증]. 따라 던지지 말 것=정훈 코어철학 일치. 관전=연금매도일 외인 받아주는지(7월 1순위). 연금 종목순위 1~3위는 [미확인]"
      },
      {
        "date": "2026-06-30",
        "title": "국민연금 7월 매도폭탄이 코스피에 미치는 진짜 영향(쇼츠)",
        "tag": "검증",
        "note": "본편 압축 — 코스피 오를수록 연금매도압력↑→반도체 대형주 지수충격, 외인 받으면 조정/빚투개인 받으면 폭락. 신용 반대매매 도미노 경고 [검증·방향]"
      },
      {
        "date": "2026-06-30",
        "title": "6/30 투자자들이 꼭 알아야 하는 투자 포인트(쇼츠)",
        "tag": "검증/미확인",
        "note": "①삼성·하닉·MU 美 DRAM 집단소송(北캘리포니아 연방법원, HBM쏠림→범용D램 인위감산·가격인상, 점유율~90% 과점) [검증] ②메가프로젝트 ③8월 반도체특별법. 채널 '소송=단기악재지만 메모리 강세신호' 해석은 [미확인·관점]. 외인 반도체 7조 매도는 [정정](실제 누적 64~94조)"
      },
      {
        "date": "2026-06-30",
        "title": "이재명 정부 550조 메가프로젝트 2차 수혜주(쇼츠)",
        "tag": "검증",
        "note": "6/29 청와대 보고회 1,500조+AI데이터센터 550조(삼성·SK 각 400조·호남 896조) [검증]. 2차수혜=냉각·공조(LG전자 칠러)·클린룸·초순수. LG전자 직접연결(강세재료). 단 한양이엔지·GST 등 소형주 워치밖·채널 단독근거 매수금지. 발주 전환 확인 필수(채널도 신중단서)"
      },
      {
        "date": "2026-06-29",
        "title": "이번주 중요 투자 포인트",
        "tag": "검증",
        "note": "폭락=반기말 리밸런싱·반도체 쏠림해소(수급). Micron $41.5B(+346%)·GM84.6%·FQ4 $50B / JPM S&P 7,800 상향 / Fed 7월 동결69%. 전부 [검증]"
      },
      {
        "date": "2026-06-29",
        "title": "삼성·하이닉스가 거품이 아닌 이유",
        "tag": "검증/미확인",
        "note": "실적·낮은PER·LTA 구독화 반박. 단 삼성 2Q 85조·선행PER 6.48배는 [미확인](7/7 잠정 전·과장경계). 방향만 채택"
      },
      {
        "date": "2026-06-29",
        "title": "삼성·SK 2000조 프로젝트 핵심(쇼츠)",
        "tag": "검증",
        "note": "청와대 영빈관 이재명·이재용·최태원 발표. 삼성+SK 호남 메모리팹 4기·10년 ~2000조. 전력·인프라 수혜(추격금지)"
      },
      {
        "date": "2026-06-29",
        "title": "쏠림장 속 살아남는 포트폴리오(쇼츠)",
        "tag": "검증",
        "note": "MS 집중포지션룰(5종목 위험30%+=쏠림). 신용 38조 사상최대[미확인·방향]. 정훈 반도체 쏠림 점검 의제"
      },
      {
        "date": "2026-06-29",
        "title": "오늘 美뉴스 3가지(쇼츠)",
        "tag": "미확인",
        "note": "D램 담합 집단소송(초기 소장·공급빡빡 방증 해석)·인텔 슈퍼클로 7월·앤트로픽 재개검토. 단일출처 방향만"
      }
    ],
    "track_record": [
      {
