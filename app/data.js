...
window.APP_DATA = {
  "generated_at": "2026-06-22 20:14 KST",
  "as_of": "KR 6/22 종가 확정 / US 6/22 재개 실측(23:04 KST, 갭다운 회피) · v27 저녁 점검 || 6/22밤 4종목 score 최신화(MSFT71·ORCL74·LG66·현대49) + 검증기 별점↔스코어 ±1 정성가중 정책 확정",
  "source_report": "docs/reports/report_v27_2026-06-22.md",
  "offline": false,
  "fx": {
    "usdkrw": 1537.45
  },
  "totals": {
    "assets_krw": 8437274,
    "stocks_value_krw": 7812503,
    "cash_krw": 624771,
    "day_change_krw": -107724,
    "day_change_pct": -1.36,
    "total_pnl_krw": 511577,
    "total_pnl_pct": 7.01
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "updated": "2026-06-22",
    "source": "docs/reports/report_v27_2026-06-22.md",
    ...
    "headline": "6/22 저녁 장마감 후 신규 4편 = MU·SK하이닉스·국민연금 트리거 직결. ①SK하이닉스 시총1위·ADR(목표430만 출처=한화투자[정정], 채널 '하나' 오인)·MU 6/25새벽=메모리 풍향계[검증] ②美이란 60일 임시MOU·유가↑+원화약세=한국증시 악조합[검증프레임] ③中희토류 통제·월러 연준 22시 연설[미확인] ④국민연금 7월 55조 매도, 관건=외인이 받아주냐(허용상단 ~26.8%, 채널 '30%' 혼선[정정]·목표20.8% 정확)[검증]. 채널 트랙=방향 정확·증권사명/비율 디테일 오류 반복.",
    "latest_videos": [
      {
  ...
  "outlook": [
    {
      ...
      "tag": "관망·집행0",
      "dir": "→",
      "text": "집행 0·미국예약 0건 확정(17:30 폰창 관망대로, 체결 없음). 코스피 9,114.55 종가 사상최고지만 외인 −2.55조 2일연속=재유입 분수령 실패(신중), 개인 +2.12조 흡수. SK하이닉스 시총 단일1위. NAVER 222k 매수존 이탈→1차 보류. ★미장 22:30 재개=갭다운 회피·강보합(S&P +0.33%·필반 +1.89%·MU +5.10%), v26 '약보합' 대비 양호. GOOGL −4.25%(유상증자 희석)."
    },
    {
      "horizon": "내일 (6/23 화)",
      "tag": "분수령·MU베이킹",
      "dir": "→",
      "text": "새벽 MSCI 시장분류=선진국 편입 실패 전망(차기 2028 순연, 외인 단기 실망). ★저녁 폰창 유일 액션=MU 절반차익(약 0.02주) 사전 베이킹 — 6/25 새벽 실적 폰 미가용 대비(MU 오늘 +5.10%로 트림 단가 유리·6/24 저녁 백업). 외인 재유입 전환 여부가 추세 판가름. 밤 22시 월러 연준연설(달러 역할, 대응 불요)."
    },
    {
      "horizon": "이번주 (6/22~26)",
      "tag": "이벤트 주간",
      "dir": "→",
      "text": "반도체 호황 '시험 주간'. 6/25(목) 더블 분수령 = MU 실적(美 6/24 마감후=KST 6/25 새벽)+美 5월 PCE(밤 21:30). 둘 다 야간/새벽 폰 미가용 → 6/23~24 20:50 전 예약 베이킹. 외인 2일연속 매도 → 재유입 재확인이 추세 판가름. 유가 $80·고환율 1,537이 할인율 변수."
    },
    {
      "horizon": "이번달~7월",
      "tag": "관망·7월리스크",
      "dir": "→",
      "text": "3차 트랜치(META·AVGO) FOMC 매파로 보류 중. 재개 조건 = 비둘기 전환 / META 7/29 실적 / 외인 순매수 복귀 중 하나. ⚠️7월 NPS 리밸런싱 재개=국내비중 14.9→20.8% 상향분 최대 55조 기계적 매도(받침대 제거) + 빚투 38조 레버리지 리스크. 안전핀 코스피 7,500(현 9,114, +21.5% 버퍼)."
    }
  ],
  "index_forecast": [
    {
      ...
      "high": 9350,
      "dir": "→",
      "note": "6/22 종가 사상최고(외인 −2.55조 던졌으나 개인+기관 흡수). 외인 2일연속 매도=신중, 6/23 재유입 재확인 전 추세 미확정. MSCI 편입 실패·7월 NPS 55조 받침대 제거 주시."
    },
    {
      "name": "나스닥",
      "ref": 26523.49,
      ...
      "high": 27100,
      "dir": "→",
      "note": "6/22 재개 +0.02% 강보합(갭다운 회피, '약보합' 전망보다 양호). MU 6/25 실적·PCE가 방향 결정. 필반 주도."
    },
    {
      "name": "S&P500",
      "ref": 7525.1,
      ...
      "high": 7620,
      "dir": "↑",
      "note": "6/22 재개 +0.33%·VIX 안정. 美-이란 60일 로드맵으로 갭다운 회피. 6/25 PCE 분수령."
    },
    {
      "name": "필라델피아반도체",
      "ref": 14612.54,
      ...
      "high": 15200,
      "dir": "↑",
      "note": "6/22 재개 +1.89% 반도체 주도. MU 6/25 실적이 섹터 분수령. good-news-priced-in 위험 잔존."
    }
  ],
  "tasks": {
    "today": [
      {
        "id": "t-0622-1",
        "text": "✅확인됨: 외인 코스피 6/22 −2조5,453억 순매도(2일연속)·개인 +2.12조·기관 +3,305억. 재유입 분수령 실패=신중 경보(단 지수는 흡수로 사상최고 9,114.55)",
        "done": true
      },
      {
        "id": "t-0622-2",
        "text": "✅결정: NAVER 1차 매수 보류 확정 — 외인 재유입 실패+종가 222k 매수존(225~235k) 이탈+정리후보 3중 미충족. 폰창 무집행",
        "done": true
      },
      {
        "id": "t-0622-3",
        "text": "✅확인: 오늘밤 22:30 美 재개 = 선물 약보합(갭다운 아님)·신규 진입 보류(룰7·3차 동결). 미국 예약 0건",
        "done": true
      },
      {
        "id": "t-0622-4",
        "text": "SK하이닉스 시총 단일1위 등극 확인 / 美 SEC ADR 승인 = 6/22 미발표(넷째주 유력→8월 상장). 헤드라인 주시 유지",
        "done": false
      }
    ],
    "week": [
      {
        "id": "t-w-1",
        "text": "6/23(화) 새벽 MSCI 시장분류 발표 확인 — 선진국 편입 실패 전망(차기 2028 순연), 외인 반응 점검",
        "done": false
      },
      {
        "id": "t-w-2",
        "text": "★6/23~24(화·수) 저녁 폰창 MU 절반차익 사전 베이킹(소수점=시장가, 절반 0.02주) — 6/25 새벽 실적 대비",
        "done": false
      },
      {
        "id": "t-w-3",
      ...
      {
        "id": "t-w-4",
        "text": "6/23 외인 재유입 전환 여부 = 추세 분수령 확인 + 안전핀 코스피 7,500 모니터링(현 9,114) + 유가·환율 추적",
        "done": false
      }
    ],
    "month": [
  ...
  "orders": [
    ...
    },
    {
      ...
      "amount_krw": 0,
      "date": "2026-06-23",
      "note": "+51% 정점·목표 ±55% 분산·trailing P/E 40x·집중도 헤지. 6/25 새벽 실적 폰 미가용 → 6/23~24 저녁 폰창 소수점(시장가) 사전 베이킹. 가이던스 확인 전 절반만."
    }
  ],
