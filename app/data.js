...
window.APP_DATA = {
  "generated_at": "2026-06-30 16:35 KST",
  "as_of": "2026-06-30 화 밤 나이트체크(v35 nightcheck) — 국장 종가 8,476.48 확정·美 개장초 리스크온(SOX +2.95%). ★오늘 17:30 미국 예약주문 0건→22:30 체결 없음·평단 무변동. 보유 16 홀딩·신규 0. 별점·스코어 v34 유지.",
  "source_report": "docs/reports/report_v35_nightcheck_2026-06-30.md",
  "offline": false,
  "fx": {
    "usdkrw": 1551.0
  },
  "totals": {
    "assets_krw": 8144362,
    "stocks_value_krw": 7519591,
    "cash_krw": 624771,
    "day_change_krw": 72087,
    "day_change_pct": 0.97,
    "total_pnl_krw": 240482,
    "total_pnl_pct": 3.3
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "headline": "6/30 신규 4편(본편1+쇼츠3) — ①NPS 7월 리밸런싱 D-1: 74조는 코스피 9,000 가정 최대치(현 8,476이라 부담 작음)·비중조정 교체매도라 따라 던지지 말 것 [검증] ②삼성·하닉·MU 美 DRAM 집단소송 [검증·신규 오버행] ③메가프로젝트 1,500조+AI데이터센터 550조→LG전자 냉각 수혜 [검증] ④외인 반도체 7조 매도 [정정]→실제 누적 64~94조. 집행 결론 불변=관망(외인 8일째 매도·갭업 추격금지)",
    "setups": [
      {
        "id": "setup-메모리코어-0629",
        "ticker": "005930.KS",
    ...
    "latest_videos": [
      ...
      },
      {
        ...
        "tag": "검증",
        "summary": "본편 압축 — 코스피 오를수록 연금매도압력↑→반도체 대형주 지수충격, 외인 받으면 조정/빚투개인 받으면 폭락. 신용 반대매매 도미노 경고 [검증·방향]"
      },
      {
        "date": "2026-06-30",
        "title": "6/30 투자자들이 꼭 알아야 하는 투자 포인트(쇼츠)",
        "tag": "검증/미확인",
        "summary": "①삼성·하닉·MU 美 DRAM 집단소송(北캘리포니아 연방법원, HBM쏠림→범용D램 인위감산·가격인상, 점유율~90% 과점) [검증] ②메가프로젝트 ③8월 반도체특별법. 채널 '소송=단기악재지만 메모리 강세신호' 해석은 [미확인·관점]. 외인 반도체 7조 매도는 [정정](실제 누적 64~94조)"
      },
      {
        "date": "2026-06-30",
        "title": "이재명 정부 550조 메가프로젝트 2차 수혜주(쇼츠)",
        "tag": "검증",
        "summary": "6/29 청와대 보고회 1,500조+AI데이터센터 550조(삼성·SK 각 400조·호남 896조) [검증]. 2차수혜=냉각·공조(LG전자 칠러)·클린룸·초순수. LG전자 직접연결(강세재료). 단 한양이엔지·GST 등 소형주 워치밖·채널 단독근거 매수금지. 발주 전환 확인 필수(채널도 신중단서)"
      },
      {
        "date": "2026-06-29",
        "title": "이번주 중요 투자 포인트",
        "tag": "검증",
        "summary": "폭락=반기말 리밸런싱·반도체 쏠림해소(수급). Micron $41.5B(+346%)·GM84.6%·FQ4 $50B / JPM S&P 7,800 상향 / Fed 7월 동결69%. 전부 [검증]"
      },
      {
        "date": "2026-06-29",
        "title": "삼성·하이닉스가 거품이 아닌 이유",
        "tag": "검증/미확인",
        "summary": "실적·낮은PER·LTA 구독화 반박. 단 삼성 2Q 85조·선행PER 6.48배는 [미확인](7/7 잠정 전·과장경계). 방향만 채택"
      },
      {
        "date": "2026-06-29",
        "title": "삼성·SK 2000조 프로젝트 핵심(쇼츠)",
        "tag": "검증",
        "summary": "청와대 영빈관 이재명·이재용·최태원 발표. 삼성+SK 호남 메모리팹 4기·10년 ~2000조. 전력·인프라 수혜(추격금지)"
      },
      {
        "date": "2026-06-29",
        "title": "쏠림장 속 살아남는 포트폴리오(쇼츠)",
        "tag": "검증",
        "summary": "MS 집중포지션룰(5종목 위험30%+=쏠림). 신용 38조 사상최대[미확인·방향]. 정훈 반도체 쏠림 점검 의제"
      },
      {
        "date": "2026-06-29",
        "title": "오늘 美뉴스 3가지(쇼츠)",
        "tag": "미확인",
        "summary": "D램 담합 집단소송(초기 소장·공급빡빡 방증 해석)·인텔 슈퍼클로 7월·앤트로픽 재개검토. 단일출처 방향만"
      }
    ],
    "track_record": [
      {
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/30 화) 마감",
      "tag": "갭업→외인 매물에 되돌림",
      "dir": "→",
      "text": "코스피 8,476.48(+0.97%) — 장중 8,626(+2.79%)까지 갭업했으나 외인 -3.79조 매물에 되돌림 마감('좋다 말았네'). 외인 8거래일째 순매도(강도 -7.7조→-3.79조 둔화이나 갭업마다 매도=전환 미발생). 기관 +2.93조 방어. 폰창 A/B블록 전량 관망(삼성 334k 매수존 +9.5% 위·두산E 86,800 10만 미달·AAPL $281.74 트림 $305 미달). 보유 16 홀딩·신규 0·현금 보존."
    },
    {
      "horizon": "내일 (7/1 수)",
      "tag": "NPS 재개+韓수출 분수령",
      "dir": "→",
      "text": "NPS 국내주식 리밸런싱 재개(최대 60~74조 잠재매도·삼성/하닉 집중·받침대 제거)+韓 6월수출(1~20일 +60.4%·반도체 +188%). 밤 美 ADP·ISM. 외인 전환+수출 호조가 겹치면 강세복귀 스위치 명분, 매물벽이 이기면 8,000 시험."
    },
    {
      "horizon": "이번주 (6/30~7/4)",
      "tag": "트리플 확인·고용주간",
      "dir": "→",
      "text": "★외인 전환+환율 1,500 꺾임이 키. 트리플 확인=7/1 수출·7/2(목)21:30 美고용(조기발표·폰밖)·7/7 삼성. 7/4 美 휴장 단축주간=얇은 거래·변동성↑. 안전핀 7,500(+11.9%)·2차 8,000(+4.9% 근접). 관망 우위."
    },
    {
      "horizon": "이번달~7월",
      "tag": "3성적표·환율24시간·ADR",
      "dir": "→",
      "text": "7/6 환율 24시간 개시(MSCI 숙제·새벽변동성)·7/7경 삼성 잠정(86±5조)·7/10 하닉 ADR(SKHY·데뷔전 진입금지)·7/16 한은 금통위·7/29 META+하닉+美빅테크 capex·7/30 AAPL+FOMC. 전부 폰창 밖→예약 베이킹. 메모리 집중도=하닉 ADR로 더 늘리지 말 것."
    }
  ],
  "index_forecast": [
    {
      ...
      "dir": "↗",
      "confidence": "확정",
      "note": "6/30 종가 8,476.48(+0.97%) 확정. 장중 8,626 갭업 외인 매물에 되돌림. 7/1 NPS 재개·외인 8일째 매도가 상단 캡. 안전핀 7,500(+13.0%)·2차 8,000(+6.0%)."
    },
    {
      "name": "코스닥",
      "ref": 920.57,
      ...
      "high": 960,
      "dir": "→",
      "confidence": "확정(6/29 종가)",
      "note": "6/29 +8.13%(920.57) 2차전지·바이오 순환매 폭등 후. 과열 소화·차익실현 주의."
    },
    {
      "name": "나스닥",
      "ref": 25820.15,
      ...
      "dir": "↗",
      "confidence": "확정(6/29 종가)",
      "note": "6/29 +2.07%(25,820) Mag7 주도 리스크온. GOOGL 다우데뷔·TSLA +8.46%. 단 6/30 분기말 리밸런싱(JPM ~$165B)·7/2 NFP 변동성 주의."
    },
    {
      "name": "필라델피아반도체",
      "ref": 13709.66,
      ...
      "dir": "↗",
      "confidence": "확정(6/29 종가)",
      "note": "6/29 +3.83%(13,710) 개장초 −2.14% 풀반전 — MU sell-the-news 소화·재평가. 단 SOX 60일 +5% 9회=천장권 극단변동성(리스크 데스크 경계)."
    }
  ],
  "tasks": {
    "today": [
      {
        "id": "t-0630e-1",
        "text": "✅확인: 국장 갭업(장중 8,626)을 외인 -3.79조가 되돌림(8,476.48 마감). 외인 8거래일째 매도=강세복귀 스위치 미점등. 보유 16 전량 홀딩·신규 0 유지.",
        "done": true
      },
      {
        "id": "t-0630e-2",
        "text": "폰창 A블록(국내 시간외 17:30~18:00): 주문 없음=관망. 삼성 334k(존 +9.5% 위)·두산E 86,800(10만 -13.2%)·KT&G 169,700(165k +2.8% 위)·NAVER 199k(정리후보 보류) 전부 미발동.",
        "done": false
      },
      {
        "id": "t-0630e-3",
        "text": "폰창 B블록(미국 예약 20:50 전): 예약 없음. AAPL $281.74(트림 $305 -7.6% 미달)·GOOGL $353.65(재배치 $330 +7.2% 위·트림 연동). 7/2 TSLA 인도는 관찰만(추격금지).",
        "done": false
      },
      {
        "id": "t-0630e-4",
        "text": "내일 7/1 NPS 리밸런싱 재개 D-1 대비 현금 보존(624,771원). 경제사냥꾼 6/30 4편 반영: NPS '비중조정이라 따라 던지지 말것'[검증]·DRAM소송[검증·트래킹]·메가 LG전자 냉각[검증].",
        "done": false
      }
    ],
    "week": [
  ...
  "orders": [
    {
      ...
      "amount_usd": 308,
      "date": "2026-06-28",
      "note": "[지정가 오더북·6/30 나이트체크 22:30] AAPL $285.44(+1.31%) = 트림조건 $305 대비 −6.4% 미달 → 미발동(정상). 오늘 17:30 폰창 예약 0건 → 22:30 체결 대상 없음·평단 무변동. 조건=$305 회복 시 정수1주 $308 지정가 20:50 전 예약→GOOGL 재배치. 미회복 시 7/30 FY Q3 보류."
    },
    {
      "id": "o-googl-rebal-1",
      ...
      "amount_usd": 300,
      "date": "2026-06-28",
      "note": "[지정가 오더북·6/30 나이트체크] GOOGL $351.65(−0.57%·$330 +6.6% 위·미도달). 6/29 다우데뷔. 트림(AAPL) 미발동→재배치도 대기. $330 이하 눌림서 AAPL 트림 대금으로 소수점 적립. 컨센 $406~493."
    },
    {
      "id": "o-ktg-1",
