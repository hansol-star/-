...
window.APP_DATA = {
  ...
  "holdings": [
    ...
    },
    {
      ...
      "comment": "메모리 원가 직격(맥북·아이패드 가격인상). 마진방어 vs 볼륨감소 양면, 7월말 FY Q3가 검증대. 패닉셀 금지(여전 이익권)·분수주 실효↓.",
      "issues": [
        {
          "date": "2026-06-26",
          "tag": "검증",
  ...
  "hunter": {
    ...
    "updated": "2026-06-26",
    "source": "docs/reports/report_v32_nightcheck_2026-06-26.md",
    ...
    "headline": "★6/26 저녁 신규 3편: ①온세미-시냅틱스 $7B 인수 등 AI M&A 러시(반도체 사재기)·PCE 재가속 매파(단 채널 4.1%는 정정→실제 core ~3.3%) ②코스피 또 폭락 사후분석=반전트리거 '외인 하이닉스 매도중단+환율 1,500 꺾임'(=우리 강세복귀 스위치와 동일) ③SK하이닉스 ADR 7/10 나스닥(영익 299조는 자막오류 정정→수십조). 신규 매수·조정 명분 추가 없음=관망 유지. 첫 반등 데드캣 추격금지 프레임 재확인.",
    "latest_videos": [
      {
        "id": "미국-핵심3가지-0626저녁",
        "date": "2026-06-26",
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/26 금·종가 확정)",
      "tag": "급락·서킷브레이커·동반투매·관망",
      "dir": "↘",
      "text": "🔴 코스피 -5.81%(8,411·-519p) 급락 — 장중 -8%대 8,100선 서킷브레이커(올해5번째) 후 회복. 어제 +5.42% 반도체 랠리 전량 반납. 외인 -4.6조(6일째) + 기관 -3.8조(어제 +3.3조서 정반대 전환·합산 -8.4조 동반투매)·개인 +8.2조 흡수. SK하이닉스 -8.36%·삼성 -5.30% 차익실현 주도 vs 소부장 역행강세(테스 +10.4%·원익IPS +5.9% 6/29 호남팹 기대). ★폰창 집행=둘 다 관망: (A)국내 시간외=신규 매수·매도 0(NAVER 존 -12.7% 아래 싸도 외인 미전환 보류·삼성 +11.3% 위 추격금지) (B)미국 예약=신규 0(빅테크 3차 동결·AAPL 패닉셀 금지·MU 잔여 홀딩). 안전핀 7,500 +12.1%·2차 8,000 +5.1% 근접(물타기 금지). 강세복귀 스위치=외인 순매수 전환(미점등·악화)."
    },
    {
      "horizon": "내일 (6/27 토·휴장)",
      "tag": "주말 휴장·거래없음",
      "dir": "→",
      "text": "🚫 KR·US 둘 다 휴장 — 거래 없음·예약 후보 없음. 주말 폰창(09:00~20:50)은 점검 전용. 6/26 美 금요장은 22:30~05:00(KST)에 진행 중이나 평일/오버나이트 규약상 반응매매 금지. 6/27~28 주말 동안 외신·6/29 호남 발표 사전 브리핑·SK하이닉스 美상장 일정만 모니터."
    },
    {
      "horizon": "다음 거래일 (6/29 월)",
      "tag": "호남 반도체 발표",
      "dir": "→",
      "text": "6/29 이재명 대통령 주재 민관합동회의 — 삼성·SK하이닉스 광주·전남 전공정 팹 + 삼성 충남 AI DC 공식화 전망(총 400조대). 전력·용수·소부장 수혜(두산E·원익IPS) 모멘텀이나 발표≠착공 → 착공·발주 전 추격금지(원익IPS). 첫 반등 데드캣 추격금지(경제사냥꾼). 평일 폰창 17:30~ 당일 대응 가능. 발표 전후 변동성 주목."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간 마무리",
      "dir": "→",
      "text": "검은화요일(6/23 −9.99%)→6/24 +3.26% 데드캣→6/25 +5.42%(MU 비트發 반도체 단독 쏠림)→6/26. ★MU 대박 비트로 펀더 의구심은 해소됐으나 외인 5거래일 연속 순매도(단 6/25 강도 급감 -5조대→-8천억대=약한 진정 신호)=강세 복귀 스위치 미점등. PCE 코어 3.4% 매파·고환율 1,546·빅테크 약세 전이가 상단 제약. 관망 우위."
    },
    {
      "horizon": "이번달~7월",
      "tag": "관망·7월리스크",
      "dir": "→",
      "text": "3차 트랜치(META·AVGO) FOMC 매파로 보류 중(재개=비둘기 전환/META 7/29 실적/외인 복귀 중 하나). ⚠️7/1 NPS 국내 리밸런싱 재개=기계적 매도(대형주 매물집중)+신용 38조 반대매매 리스크. 7/2 美 6월 고용. 7/6 원달러 24시간 거래. 7/10 SK하이닉스 나스닥 ADR(잠정). 7/16 한은 금통위 2.50→2.75% 전망. 7/22~ 美 2분기 실적시즌. 안전핀 코스피 7,500(6/25 종가 8,930 +19.1% 버퍼)."
    }
  ],
  "index_forecast": [
    {
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0626-1",
        "text": "🔕 오늘 폰창(17:30~20:50)=경계 관망. 코스피 -5.81%(8,411) 급락·서킷브레이커 후 회복. 신규매수 0(외인 6일째+기관 동반투매 -8.4조·NAVER 존 -12.7% 아래 싸도 보류·삼성 +11.3% 위 추격금지)·트림 0. 보유 16 전량 홀딩. 외인 순매수 전환 확인되면 그때만 NAVER 정수 1주. 2차 8,000 +5.1% 근접·물타기 금지.",
        "done": false
      },
      {
        "id": "t-0626-2",
        "text": "🔕 AAPL -6.15% 폭락(맥북·아이패드 가격인상=메모리 원가직격)에도 패닉셀 금지 — 원가比 여전 +7.00% 이익권, 분수주라 부분트림 실익 미미. 7월말 FY Q3가 가격탄력성 검증대.",
        "done": false
      }
    ],
    "week": [
