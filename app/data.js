...
window.APP_DATA = {
  "generated_at": "2026-06-23 08:47 KST",
  "as_of": "KR 6/23 종가 확정(🔴검은 화요일 코스피 −9.99% 서킷브레이커) / US 6/22 종가(오늘밤 22:30 재개) · v28 부록 저녁 집행지시서 || 외인 −5.79조 투매(7배 가속)·개인 +11.1조 흡수. 펀더 스코어 v28 유지(1일 수급충격, 채점 미변경)",
  "source_report": "docs/reports/report_v28_addendum_2026-06-23.md",
  "offline": false,
  "fx": {
    "usdkrw": 1538.64
  },
  "totals": {
    "assets_krw": 8228418,
    "stocks_value_krw": 7603647,
    "cash_krw": 624771,
    "day_change_krw": -295368,
    "day_change_pct": -3.74,
    "total_pnl_krw": 302720,
    "total_pnl_pct": 4.15
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "updated": "2026-06-23",
    "source": "docs/reports/report_v28_addendum_2026-06-23.md",
    "channel_note": "테마·방향성은 빠르고 유용(로봇·AI전력·종전 등 선제 포착). 단 구체 수치는 자막오류·과장 잦음 → 방향성은 채택하되 숫자는 교차검증. 트랙레코드 개선세. ✅6/22 NPS 롱폼은 바클레이즈 130조·7~8조·외인 100조·신용 38조 핵심수치 거의 전부 정확(우수 구간). 6/23 신규 3편 자막확보(봇차단 없음) — 방향성 양호, MU EPS·매출환산 미세과장 2건 정정.",
    "headline": "🔴6/23 검은 화요일(코스피 −9.99% 서킷브레이커) — 신규 3편 자막확보. ①MU 실적=삼전·하이닉스 7월 선행지표, '소문에 사 뉴스에 팔아라' 후 가이던스 확인 진입[검증, EPS컨센 $20.47·매출~51조로 정정] ②6/23 폭락=AI 인재이탈(알파벳 ~−7%)+미금리(BofA 3회 인상설)+미실현이익 과세우려 3중[검증/미확인 혼재] ③삼전·닉스 레버리지ETF 규제 시사·회전율 122.5%[검증]. 채널 방향성 양호·수치 정정 2건. MU 발표는 6/25 새벽=폰 미가용→조건부룰만.",
    "latest_videos": [
      {
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/23 화) 마감",
      "tag": "🔴검은화요일·관망",
      "dir": "↓",
      "text": "코스피 8,203.84(−9.99%·−910.71p) 서킷브레이커(올해4번째)·코스닥 −7.94%. 외인 −5.79조·기관 −5.49조 투매(6/22 −0.77조→7배 가속), 개인 +11.1조 역대최대 흡수. 강세 논지 수급기반 붕괴. 폰창=관망: 패닉셀 금지(코어·LG전자 손절선 없음)·칼날잡기도 금지(서킷당일 진입=추격금지 위반). MU 절반차익=6/24 저녁 유지(분수주 시장가라 야간 갭다운 불리). 미국 신규 예약 0·빅테크 3차 동결."
    },
    {
      "horizon": "내일 (6/24 수)",
      "tag": "분수령·MU베이킹",
  ...
  "orders": [
    ...
    },
    {
      ...
      "amount_krw": 0,
      "date": "2026-06-24",
      "note": "+61.7% 정점·집중도 헤지. 6/25 새벽 실적 폰 미가용 → ★6/24 저녁 폰창 소수점(시장가) 예약(집행 22:30 US개장=실적 직전). 검은화요일에도 6/23 오늘밤 아님 — 분수주는 시장가 전용이라 KR 폭락 전염 갭다운 시 오히려 나쁜 단가('고점 확보' 논리 깨짐). Needham $1,550·Bernstein $1,300 상향. 가이던스 확인 전 절반만."
    }
  ],
