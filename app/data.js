...
window.APP_DATA = {
  "generated_at": "2026-06-24 00:27 KST",
  "as_of": "KR 6/23 종가 확정(🔴검은 화요일 코스피 −9.99% 서킷브레이커, 6/24 개장 전 프로즌) / US 6/23 최종종가(05:00 KST 마감) · v30 아침 풀브리핑 || US 반도체 셀오프 마감까지 심화: SOX −7.87%·MU −13.18%·NVDA −4.13%·ANET −7.08%·ORCL −5.66%·TSLA −5.79% vs MSFT +1.80%(유일 상승)·META −0.29% 메가캡 방어. MSCI 한국 선진국 관찰대상 재제외 확정. 펀더 스코어 v29 유지(수급·센티·매크로 충격, 채점 미변경)",
  ...
  "totals": {
    "assets_krw": 8139531,
    "stocks_value_krw": 7514760,
    "cash_krw": 624771,
    "day_change_krw": -75362,
    "day_change_pct": -0.99,
    "total_pnl_krw": 213833,
    "total_pnl_pct": 2.93
  },
  "safety": {
    "pin": 7500,
  ...
  "outlook": [
    {
      ...
      "tag": "🔴확인의 날·관망",
      "dir": "→",
      "text": "검은화요일(6/23 −9.99%) 다음날 = '줍줍'이 아니라 '확인'의 날. 강세엔진(외인 −5.79조) 꺼진 채 ★MSCI 선진국 관찰대상 재제외 확정(44조 유입기대 소멸)+간밤 미장 반도체 셀오프 마감까지 심화(SOX −7.87%·MU −13.18% 최종). 폰창(17:30~20:50) 액션 = ①MU 절반차익(0.02주) 조건부 예약 베이킹 1건 ②코스피 8,000 사수+외인 진정 확인 시에만 삼성/NAVER 정수 1주 택1 — 그 외 전부 관망. 추격·칼날잡기·물타기 금지, 안전핀 7,500 주시(버퍼 +9.4% 반토막). 패닉셀도 금지(코어 펀더 무손상). 보유 16종목 수량/평단 변동 0·현금 624,771원."
    },
    {
      "horizon": "내일 (6/25 목)",
      "tag": "더블분수령·폰미가용",
  ...
  "index_forecast": [
    {
      ...
      "high": 8500,
      "dir": "→",
      "note": "🔴6/23 검은화요일 −9.99%(−910.71p) 서킷브레이커·역대최대낙폭. 외인 −5.79조·기관 −5.49조 동반투매, 개인 +11.1조 흡수. MSCI 선진국 관찰대상 재제외 확정. 안전핀 7,500까지 버퍼 +9.4%(반토막)·2차 트랜치 8,000 +2.5%(코앞). 오늘 8,000 사수·외인 진정 여부가 분수령(8,000 하회=위험구간). 약세 출발 우위(환율 고착·미 반도체 셀오프 전염)."
    },
    {
      "name": "나스닥",
      "ref": 25587.04,
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0624-1",
        "text": "🔴'확인의 날' — 폰창 기본값=관망. 오늘 장중 외인 매도 진정 + 코스피 8,000 사수 여부 확인이 최우선(8,000 하회=위험구간·매수보류, 7,500 하회=전면 동결). 패닉셀도 금지(코어 펀더 무손상)",
        "done": false
      },
      {
        "id": "t-0624-2",
        "text": "★저녁 폰창(17:30~) MU 절반차익(0.02주, 소수점=시장가) 조건부 예약 베이킹 — 집행 22:30(6/25 새벽 실적 직전). 단 저녁 시세 −13% 추가 갭다운 지속이면 '단가 불리→실적 보고 판단' 보류도 합리(택1, 저녁 시세 보고 결정)",
        "done": false
      },
      {
        "id": "t-0624-3",
        "text": "조건부 정수 1주: 8,000 사수+외인 진정 시에만 삼성 1주(≈310,000원, 매수존 +1.6%) 또는 NAVER 1주(≈202,500원) 택1. 미충족=관망. 추격·칼날잡기·물타기 금지",
        "done": false
      },
      {
        "id": "t-0624-4",
    ...
    "week": [
      ...
      {
        "id": "t-w-4",
        "text": "안전핀 코스피 7,500 모니터링(현 8,204, 버퍼 +9.4%) + 신용 38조·환율 1,533·9월 연준 인상확률 68% 추적",
        "done": false
      }
    ],
    "month": [
  ...
  "orders": [
    {
      ...
      "amount_krw": 202500,
      "date": "2026-06-24",
      "note": "1차 트랜치. 6/23 검은화요일 종가 202,500원=매수존(225~235k) 한참 아래·외인 −5.79조 투매+정리후보=3중 보류 지속. 오늘(6/24) 외인 진정+코스피 8,000 사수 시에만 정수 1주(≈202,500원) 또는 삼성 1주(≈310,000원) 택1 분할 재검토. 8,000 하회=보류, 7,500 하회=전면 동결."
    },
    {
      "id": "o-mu-trim-1",
      "label": "MU 절반차익",
      ...
      "amount_krw": 0,
      "date": "2026-06-24",
      "note": "집중도 헤지. ⚠️6/23 미장 최종 MU −13.18%($1,051.77, +40.4%로 고점 +61.7%서 축소) — 실적 D-1 공포+SOX −7.87% 직격. '고점확보' 명분 약화. ★6/24 저녁 폰창 재점검: 집중도 완화 목적이면 결과무관 절반차익(0.02주 소수점 시장가, 집행 22:30=6/25 새벽 실적 직전) / 단가 추가 갭다운으로 불리하면 '실적 보고 판단' 보류도 합리 → 저녁 시세 보고 택1. 리스크데스크: 메모리 4종 동조 −7~13%로 집중도 현실화 → 절반차익 권고. 컨센 매출 $34.66~35.59B·EPS $19.95~20.57·HBM 완판·GM81% 펀더 유지, 골드만만 중립."
    }
  ],
