...
window.APP_DATA = {
  "generated_at": "2026-06-23 17:08 KST",
  "as_of": "KR 6/23 종가 확정(🔴검은 화요일 코스피 −9.99% 서킷브레이커) / US 6/23 개장초(~23:00 KST) · v29 저녁정리 || US 반도체 주도 동반약세(MU −9.5%·필반 −5.6%·ANET −6.2%)이나 메가캡 선방(MSFT/META/AAPL 강세). 펀더 스코어 v28 유지(수급·센티 충격, 채점 미변경)",
  "source_report": "docs/reports/report_v29_2026-06-23.md",
  "offline": false,
  "fx": {
    "usdkrw": 1533.14
  },
  "totals": {
    "assets_krw": 8135734,
    "stocks_value_krw": 7510963,
    "cash_krw": 624771,
    "day_change_krw": -284831,
    "day_change_pct": -3.65,
    "total_pnl_krw": 210037,
    "total_pnl_pct": 2.88
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "updated": "2026-06-23",
    "source": "docs/reports/report_v29_2026-06-23.md",
    "channel_note": "테마·방향성은 빠르고 유용(로봇·AI전력·종전 등 선제 포착). 단 구체 수치는 자막오류·과장 잦음 → 방향성은 채택하되 숫자는 교차검증. 트랙레코드 개선세. ✅6/22 NPS 롱폼·6/23 코스닥개편 편은 핵심수치 거의 전부 정확(우수 구간 지속). 6/23 신규 3편(오전)+1편(오후 코스닥개편) 자막확보, 정정 2건. 봇차단 영상 잔존(데이터센터 IP).",
    "headline": "🔴6/23 검은 화요일(코스피 −9.99% 서킷) 저녁정리 — US 개장초 반도체 주도 동반약세(MU −9.5%·필반 −5.6%·ANET −6.2%)이나 메가캡 선방(MSFT/META/AAPL 강세). 신규 영상 ④코스닥 구조개편: 7/1 상폐요건 강화·승강제(1군 반도체 28.5→50%)·일본 TSE 선례(니케이+37%)[전부 검증]·원익IPS=코스닥1군 수혜 거론. 검은화요일 전용 후속영상은 아직 미게시. MU 발표 6/25 새벽=폰 미가용→조건부룰만.",
    "latest_videos": [
      {
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/23 화) 마감+미장 개장초",
      "tag": "🔴검은화요일·관망",
      "dir": "↓",
      "text": "코스피 8,203.84(−9.99%·−910.71p) 서킷브레이커(올해4번째)·코스닥 −7.94%. 외인 −5.79조·기관 −5.49조 투매, 개인 +11.1조 역대최대 흡수. 폰창=관망(패닉셀·칼날잡기 둘다 금지). ★17:30 미국 예약=원래 0건(MU는 6/24로 베이킹)→체결 점검대상 없음·보유 16종목 수량/평단 변동 0·현금 624,771원 유지. US 개장초(~23:00 KST): 반도체 주도 동반약세 MU −9.5%·필반 −5.6%·ANET −6.2%·NVDA −2.6%·TSLA −3.9%이나 메가캡 선방(MSFT +2.1%·META +1.2%·AAPL +0.8%·GOOGL −0.3% 반등) → S&P −0.9%·나스닥 −1.2%. KR발 리스크오프 전염이나 광범위 패닉은 아님(반도체 국소)."
    },
    {
      "horizon": "내일 (6/24 수)",
      "tag": "분수령·MU베이킹",
      "dir": "→",
      "text": "검은화요일 후 안정 여부가 최대 관전. ★새벽 05:30 MSCI 시장분류(한국 선진국 관찰대상 미등재 컨센·골드만). ★저녁 폰창: ①외인 매도 진정·코스피 8,000 사수 확인 시 삼성/NAVER 정수 1주 분할 후보(현금 624,771원), 7,500 하회 시 전면 동결 ②MU 절반차익(0.02주) 예약(소수점 시장가, 집행 22:30=6/25 실적 직전). 단 야간 갭다운 가능."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간",
  ...
  "index_forecast": [
    {
      ...
      "high": 8500,
      "dir": "↓",
      "note": "🔴6/23 검은화요일 −9.99%(−910.71p) 서킷브레이커. 외인 −5.79조 투매·2일연속 가속, 개인 +11.1조 흡수. 안전핀 7,500까지 버퍼 +9.4%(반토막)·2차 트랜치 8,000 +2.5%(코앞). 내일 8,000 사수·외인 진정 여부가 분수령. AI인재이탈·BofA 3회인상설·과세우려 3중 트리거."
    },
    {
      "name": "나스닥",
      "ref": 26166.6,
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0623-1",
        "text": "🔴검은화요일 코스피 −9.99% 서킷브레이커. 폰창 관망 확정 — 패닉셀 금지(코어·LG전자 손절선 없음)+칼날잡기도 금지(서킷당일 진입=추격금지 위반). 살/팔 후보 없음",
        "done": false
      },
      {
        "id": "t-0623-2",
        "text": "외인 −5.79조 투매(7배 가속·2일연속) = 강세 논지 수급기반 붕괴. 내일 매도 진정·코스피 8,000 사수 여부가 분수령(안전핀 7,500 버퍼 +9.4%로 반토막)",
        "done": false
      },
      {
        "id": "t-0623-3",
        "text": "MU 절반차익=6/24 저녁 유지(오늘밤 아님). 빅테크 3차 트랜치 동결 유지(FOMC 매파+BofA 3회 인상설+AI capex 회의)",
        "done": false
      },
      {
        "id": "t-0623-4",
        "text": "거래 직전 토스/네이버금융 최종 종가 1회 재확인(LG전자·두산로보·장비주 등 Yahoo 단일소스). SK하이닉스 상장 전 진입금지(영구룰)",
        "done": false
      }
    ],
    "week": [
  ...
  "orders": [
    {
      ...
      "amount_krw": 229500,
      "date": "2026-06-23",
      "note": "1차 트랜치. 6/23 검은화요일로 종가 202,500원=매수존(225~235k) 한참 아래·외인 −5.79조 투매+정리후보=3중 보류 지속. 내일 외인 진정+코스피 8,000 사수 시에만 정수 1주(≈202,500원) 분할 재검토."
    },
    {
      "id": "o-mu-trim-1",
      "label": "MU 절반차익",
      ...
      "amount_krw": 0,
      "date": "2026-06-24",
      "note": "집중도 헤지. ⚠️6/23 밤 US개장 MU −9.5%($1,097, +46.5%로 +61.7%에서 축소) — 분수주 시장가라 베이킹 안 한 게 결과적으로 유리(오늘밤 팔았으면 단가 −9% 손해). 6/25 새벽 실적 폰 미가용 → ★6/24 저녁 폰창 재점검: 갭다운 지속이면 절반차익 명분 약화(고점확보 논리 깨짐) → '실적 전 절반 예약 vs 실적 보고 판단' 6/24 저녁 시세 보고 결정. Needham $1,550·Bernstein $1,300 상향·HBM 완판·GM81% 펀더는 유지."
    }
  ],
