...
window.APP_DATA = {
  "generated_at": "2026-06-24 11:44 KST",
  ...
  "totals": {
    "assets_krw": 8216368,
    "stocks_value_krw": 7591597,
    "cash_krw": 624771,
    "day_change_krw": -43059,
    "day_change_pct": -0.56,
    "total_pnl_krw": 290670,
    "total_pnl_pct": 3.98
  },
  "safety": {
    "pin": 7500,
  ...
  "outlook": [
    {
      ...
      "tag": "🔄데드캣 반등·집행확정",
      "dir": "↗",
      "text": "[저녁 집행 확정] 코스피 +3.26%(8,471.02) 반등했으나 ★외인 −4.66~5.16조 추가 투매(진정 아님)·개인+기관이 받은 반발매수 = 데드캣 성격(국장·경제사냥꾼 일치). 폰창 집행안 = (A)국내 시간외=전면 관망(무집행): 삼성 +9.84%로 매수존 위 이탈=추격금지, NAVER 199,400 존아래나 외인투매+정리후보 보류 → 아침 조건부('외인 진정')전제 실패로 신규매수 불성립. (B)미국 예약=MU 절반차익 0.02주 소수점 시장가 1건만 베이킹(집행 22:30=6/25새벽 실적직전·집중도 헤지). 빅테크 3차 동결. 안전핀 7,500 버퍼 +12.9%(미발동). 패닉셀 금지·외인 순매수 재전환=강세복귀 스위치(미충족). 보유 16종목 수량/평단 변동 0·현금 624,771원."
    },
    {
      "horizon": "내일 (6/25 목)",
      "tag": "더블분수령·폰미가용",
