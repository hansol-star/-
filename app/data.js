...
window.APP_DATA = {
  "generated_at": "2026-06-29 13:17 KST",
  "as_of": "2026-06-27 토 풀보고서 (US·KR 6/26 종가 프로즌·토요일 휴장·MANGOS 흡수)",
  "source_report": "docs/reports/report_v33_2026-06-27.md",
  "offline": false,
  "fx": {
    "usdkrw": 1542.86
  },
  "totals": {
    "assets_krw": 7978365,
    "stocks_value_krw": 7353594,
    "cash_krw": 624771,
    "day_change_krw": 41262,
    "day_change_pct": 0.56,
    "total_pnl_krw": 74485,
    "total_pnl_pct": 1.02
  },
  ...
  "hunter": {
    ...
    "headline": "★6/27(토) 신규: 7월 3성적표(7/7 삼성·7/16 TSMC·7/29 하닉+美빅테크)=메모리 정점 판정·전부 폰창 밖→예약 베이킹 / 마이클 버리 GPU 감가상각 회계논란(META·MSFT·GOOGL·ORCL 이익 과대)=리스크 감시 격상 / 오픈AI IPO 2027 연기설(NYT·미확인)이나 美빅테크 capex 지속=HBM 수요 불변 / ARM·SMCI=AI 2차 인프라株(고밸류 추격금지) / 골드만 한국로봇주(HL만도·로보티즈). 신규 매수·조정 명분 추가 없음=관망 유지. 채널 1차사실 정확·과장은 목표가·2027연기·배수에 집중.",
    "setups": [
      {
        "id": "setup-반전트리거-0626",
        "ticker": "^KS11",
        "label": "코스피·반도체 반등 매수(반전트리거)",
        "thesis": "경제사냥꾼 6/26 '악재 없는데 또 폭락' 사후분석 — 반전트리거 = 외인 하이닉스 매도 멈춤 + 환율 1,500서 꺾임. 외인 패시브 리밸런싱이 폭락 주범이라 외인 흐름이 키.",
        "conditions": [
          {
            "text": "외인 코스피 순매수 1~2일 연속 전환(강세복귀 스위치)",
            "met": false
          },
          {
            "text": "원/달러 1,500선서 하향 꺾임(현 ~1,535~1,541)",
            "met": false
          },
          {
            "text": "코스피 8,000(2차)·7,500(안전핀) 지지(현 8,411)",
            "met": true
          }
        ],
        "action": "매수",
        "trigger_zone": "조건 2/3+ 충족 시 삼성전자 295~305k 정수 1주 또는 코스피 2차 트랜치",
        "shares": "정수 1주",
        "status": "추적중 (1/3 met — 외인·환율 미충족)",
        "source_video": "코스피-또폭락-0626저녁",
        "date": "2026-06-26"
      },
      {
        "id": "setup-KTG-0622",
        "ticker": "033780.KS",
        "label": "KT&G 신규편입(디펜시브 분산)",
        "thesis": "경제사냥꾼⑥[정확도 최고·무오차] — 외인 51.24%(블랙록 6.15%)·1Q 영익 3,645억(+27.6%)·해외궐련 +24.6%/영익 +56%·NGP 2,793억→8,900억·주주환원 3.7조·자사주 9.5% 전량소각·DS 목표 240,000. AI 쏠림장 디펜시브 분산.",
        "conditions": [
          {
            "text": "외인 지분 50%+ 유지",
            "met": true
          ...
          {
            "text": "해외궐련 성장 지속(1Q +56%)",
            "met": true
          },
          {
            "text": "주가 165,000 이하 눌림(현 167,400)",
            "met": false
          }
        ],
        "action": "매수",
        "trigger_zone": "165,000원 이하 정수 1주 지정가(편입 전 /stock-deepdive)",
        "shares": "정수 1주",
        "status": "임박 (2/3 met — 가격존 −1.4% 근접)",
        "source_video": "경제사냥꾼 6/21 영상⑥",
        "date": "2026-06-22"
      },
      {
        "id": "setup-삼성-버리-0622",
        "ticker": "005930.KS",
        "label": "삼성전자 1차 트랜치(버리 유형장부가 매수론)",
        "thesis": "경제사냥꾼① 마이클 버리 '삼성 주당 유형장부가 닿으면 매수'·1Q 영익 57.2조 역대최대·HBM4 2026 솔드아웃·2027 공급부족. 보유 코어 비중확대 명분.",
        "conditions": [
          {
            "text": "매수존 295,000~305,000 도달(현 339,500·+11.3% 위)",
            "met": false
          },
          {
            "text": "HBM4 양산 온트랙(엔비디아·AMD 인증·2월 양산)",
            "met": true
          },
          {
            "text": "코스피 안전핀 7,500 위(현 8,411)",
            "met": true
          }
        ],
        "action": "매수",
        "trigger_zone": "295,000~305,000원 정수 1주 지정가(1차 트랜치)",
        "shares": "정수 1주",
        "status": "추적중 (2/3 met — 가격 미도달)",
        "source_video": "경제사냥꾼 6/22 영상①",
        "date": "2026-06-22"
      }
    ],
    "latest_videos": [
      {
        "id": "7월-3성적표-0627롱폼",
        "date": "2026-06-27",
        "title": "[롱폼] 경제사냥꾼이 보는 7월 3가지 핵심 투자포인트",
        "tag": "검증",
        "tickers": [
          "삼성전자",
          "MU",
        ...
        "summary": "7월=한국 반도체 심리 가를 3연속 성적표(7/7경 삼성 잠정·7/16경 TSMC·7/29 SK하이닉스+같은주 美빅테크 capex). MU=예고편, 7월 셋=본편. 메모리 변덕산업→장기계약 안정산업 체질전환(코리아디스카운트 해소). + 마이클 버리 AI 감가상각 회계논란 제기(하이퍼스케일러 GPU 수명 5~6년 과대→이익 부풀림 ~$176B·ORCL/META 과대 1·2위).",
        "points": [
          "MU 2Q $41.46B·GM 84.9%·가이던스 $50B[검증]",
          "삼성 1Q26 OP 57.2조[검증] / 2Q 'FnGuide ~86조' 단정금지[미확인·방향만]",
          "마이클 버리 GPU 감가상각 회계논란(2028 ORCL +26.9%·META +20.8% 이익 과대)[검증·실재이슈]"
        ],
        "caveats": [
          "7/7·7/16·7/29 전부 평일밤/새벽=폰창 밖→예약 베이킹 필수(7/29 하닉+美빅테크=META·MSFT·GOOGL·ORCL 동시 트리거)",
          "버리 감가상각=리스크데스크 META·MSFT·GOOGL·ORCL 감시항목 격상"
        ],
        "link": "https://www.youtube.com/results?search_query=경제사냥꾼+7월+3가지+핵심+투자포인트"
      },
      {
        "id": "오픈AI-상장무산-0627",
        "date": "2026-06-27",
        "title": "[쇼츠] 오픈AI '상장 무산' 위기→삼전·닉스 영향",
        "tag": "검증·미확인",
        "tickers": [
          "NVDA",
          "MU",
        ...
        "summary": "NYT발 오픈AI IPO 2027 연기 검토(원래 3~4Q). 트리거=SpaceX 상장후 $135→$200→$153 되밀림. 단 연기≠AI투자 중단 — 美빅테크4 ~$6,350억 인프라투자 지속→HBM 수요 불변(보유 NVDA·MU·삼성 강세 유지 논거).",
        "points": [
          "美빅테크 AI capex 수천억달러 지속[검증]",
          "오픈AI 2027 연기 단정[미확인·NYT '검토' 보도단계]·$1T 몸값[미확인]"
        ],
        "caveats": [
          "단기엔 AI밸류 거품의심→반도체 프리미엄 변동성, 중기엔 capex 지속=메모리 수요 불변"
        ],
        "link": "https://www.youtube.com/results?search_query=경제사냥꾼+오픈AI+상장+무산"
      },
      {
        "id": "SMCI-2차수혜주-0627",
        "date": "2026-06-27",
        "title": "[쇼츠] 월가가 '반도체 2차 수혜주'로 콕 집은 종목=SMCI",
        "tag": "검증·미확인",
        "tickers": [
          "NVDA",
          "ANET"
        ],
        "summary": "슈퍼마이크로(SMCI)=엔비디아 차세대 베라 루빈 NVL72 시스템 빌더·출시 파트너 등재→당일 ~+17% 급등(엔비디아는 -1%=1차→2차 인프라 로테이션). 봐야할 핵심=$390억 주문 현금화·마진(현 10%)·신주희석.",
        "points": [
          "SMCI-엔비디아 베라루빈 NVL72/HGX Rubin NVL8 지원·랙스케일 액냉[검증]·당일 ~+17%[검증]",
          "$390억 주문·마진 10%·렉매출 2026 $240억→$510억[미확인]·발표 타이밍 1월표기 검색오류 가능[주의]"
        ],
        "caveats": [
          "NVDA(루빈 차세대 호재 보강)·ANET(AI인프라 인접). SMCI 미보유·회계전력·저마진=추격경계",
          "'1차 NVDA 과열→2차 인프라株 분산'=AI슈퍼사이클 분산 철학 정합"
        ],
        "link": "https://www.youtube.com/results?search_query=경제사냥꾼+SMCI+반도체+2차+수혜주"
      },
      {
        "id": "미국-핵심3가지-0626저녁",
        "date": "2026-06-26",
        "title": "[쇼츠] 오늘 투자자들이 꼭 봐야 하는 미국 핵심 투자 포인트 3가지",
        "tag": "검증·정정1·미확인",
        "tickers": [
          "삼성전자",
          "MU"
        ],
        "summary": "①반도체 AI '사재기' M&A: 온세미가 시냅틱스 $7B 전액주식 인수(2027 중반 클로징)·퀄컴 $40억·세일즈포스 $36억 흐름 ②성장주→가치주 로테이션(나스닥↓ 다우 사상최고) ③PCE 급등→연준 매파→9월 인상 베팅. 빅테크 디레이팅 매크로 근거·메모리 세트 수혜(삼성·MU).",
        "points": [
          "온세미-시냅틱스 $7B 전액주식 인수[검증] (단 인수자 온세미 시간외 -7.4%·채널은 시냅틱스 +6%만 부각)",
          "PCE '전년비 4.1%·3년만 4% 돌파'[정정]→실제 core PCE ~3.3%대(방향=재가속 매파는 사실)",
          "다우 사상최고·CAT +6%·9월 인상 80%[미확인]"
        ],
        "caveats": [
          "PCE 4.1% 숫자 폐기(실제 core ~3.3%), 방향만 채택",
          "인수자 온세미 급락은 누락된 채 피인수사 상승만 부각"
        ],
        "link": "https://www.youtube.com/watch?v=76tSug4C3kY"
      },
      {
        "id": "코스피-또폭락-0626저녁",
        "date": "2026-06-26",
        "title": "[쇼츠] 악재는 없는데 코스피가 '또' 폭락한 진짜 이유",
        "tag": "검증·미확인",
        "tickers": [
          "삼성전자",
          "SK하이닉스",
        ...
        "summary": "①MU 호재(매출 $41.5B·GM 84.9%)=동시에 차익실현 신호 ②안 잡히는 환율→외인 매도 증폭 ③외인 패시브 비중 12~13%→10% 기계적 리밸런싱. ★반전트리거=외인 하이닉스 매도 멈춤+환율 1,500서 꺾임(우리 강세복귀 스위치와 동일). 당일 수급(외인+기관 -8.4조·개인 +8.2조)과 방향 일치.",
        "points": [
          "MU 매출 $41.5B·GM 84.9%[검증]",
          "외인 패시브 비중 12~13%→10% 리밸런싱[미확인]",
          "서킷 후 다음날 3~5% 반등 통계[미확인·일반화]"
        ],
        "caveats": [
          "안전핀(코스피 7,500 하회 동결)은 별개로 그대로 가동",
          "애플 당일 -6%·가격인상 공식발표는 교차검증 못함(수치 보류)"
        ],
        "link": "https://www.youtube.com/watch?v=RzNXArqsUZk"
      },
      {
        "id": "sk하이닉스-adr-0626",
        "date": "2026-06-26",
        "title": "SK하이닉스 '나스닥 상장' 후 주가 패턴 전부 뜯어왔습니다",
        "tag": "정정·미확인",
        "tickers": [
          "SK하이닉스",
          "삼성전자",
        ...
        "summary": "①ADR 7/10 나스닥 상장(티커 SKHY·주관 BofA/Citi/GS/JPM·신주 2.5%·~45조 조달) ②목표 420만(PBR 6.7배=MU·키옥시아 평균 -10%) ③다음 카드=지수편입(나스닥100 12월·SOX 내년9월)+액분. '소문에 사서 뉴스에 판다→7/10 차익실현 조정 가능'=추격금지 룰3 동일.",
        "points": [
          "ADR 7/10·티커 SKHY·신주 2.5%·~45조 조달[미확인]",
          "영업이익 '2026 299조·2027 449조'[정정/자막오류]→실제 수십조원대",
          "목표 420만·PBR 6.7배는 단일 증권사 가정[미확인]"
        ],
        "caveats": [
          "영익 299조는 자릿수 깨진 자막오류(폐기), '이익 급증' 방향만",
          "정훈 직접 보유 아님(워치)=삼성·반도체 코어 동행지표로 활용"
        ],
        "link": "https://www.youtube.com/watch?v=NvLTS9K1C1U"
      },
      {
        "id": "7월-부동산-세제-0625",
        "date": "2026-06-25",
        "title": "7월, 주식 투자자들이 반드시 '부동산'을 꼭 챙겨봐야 하는 이유",
        "tag": "미확인(방향성)",
        "tickers": [],
        "summary": "7월말 세제개편 본질=증세 아닌 '자산시장 관리'(부동산 누르고 코스피로 자금 유도). 1~4월 초과세수 ~22조(반도체 법인세·증권거래세). 역설: 주식·채권 팔아 집 산 자금 3.7조, 15억초과 매수 中 주식판돈 비중 13.2%(첫 두자릿수). 국장 매크로 보강이나 수치 전부 미확인=방향성만.",
        "points": [
          "7월말 세제개편=자산시장 관리(부동산↓→코스피 자금유도) 정책의도[미확인 해석]",
          "1~4월 초과세수 ~22조[미확인, 방향=초과세수 발생은 정부발언 정합]",
          "강남3구 집중·15억초과 매수 中 주식판돈 13.2%[미확인]"
        ],
        "caveats": [
          "'부동산↓→주식↑ 보장 아님'은 채널 스스로 단서(균형적)",
          "22조·머니무브 수치 자막원천 미확인",
          "세부담 실제 반영은 2027년 시차"
        ],
        "link": "https://www.youtube.com/watch?v=NTGPuYzkUdo"
      },
      {
        "id": "바이오-랠리-0625",
        "date": "2026-06-25",
        "title": "[쇼츠] 월가에서 '바이오주' 역대급 상승장 올 수도 있다는 이유",
        "tag": "검증·정정1",
        "tickers": [],
        "summary": "BIO 2026(샌디에이고) 한국 미국 다음 최다 참가·'코리아 라이징' 단독세션. 美 중국바이오 규제 강화→일감 한국行. 삼성바이오 록빌 인수로 CDMO 84.5만L, SK바이오팜-Insilico 25.7억$(≈3.9조). 정훈 미보유(바이오)=워치 확장 신호로만 참고.",
        "points": [
          "BIO 2026 K바이오 사전미팅 460건[검증]",
          "삼성바이오 록빌 인수→84.5만L[검증]·SK바이오팜-Insilico 25.7억$(≈3.9조)[검증]",
          "1Q 바이오 M&A $840억[미확인]"
        ],
        "caveats": [
          "Insilico=중국계 기업(미중규제 내러티브와 미묘하게 충돌)",
          "정훈 미보유 섹터=직접 액션 없음"
        ],
        "link": "https://www.youtube.com/watch?v=KVG-3vnVUEY"
      },
      {
        "id": "삼성전자우-괴리율-0625",
        "date": "2026-06-25",
        "title": "[쇼츠·구독자전용] 삼성전자우(우선주) 분석",
        "tag": "정정·미확인",
        "tickers": [
          "005930.KS"
        ],
        "summary": "보통주 35만 vs 우선주 23만·괴리율 확대(채널 34%→실제 26~32% 정정). 우선주=AI실적을 할인에 사는 수단. ★삼성 90조 자사주 매입설 1개월내 공시 예고(우선주 포함여부가 핵심). 보유 삼성전자 직결 — 90조 자사주 공시 트래킹 가치 높음.",
        "points": [
          "보통주-우선주 괴리율: 채널 34%[정정]→실제 26~32%(방향=확대는 검증)",
          "삼성 90조 자사주설 1개월내 공시 예고[미확인, 삼성 규모·일정 미확정 선그음]",
          "우선주 외국인 76%[미확인]·보통주 외인 47.6%(연중최저)"
        ],
        "caveats": [
          "90조 자사주는 채널 자체 인용(삼성 미확정)",
          "보통주 자사주 기대 선반영→우선주 괴리축소 후행 논리는 트래킹용"
        ],
        "link": "https://www.youtube.com/watch?v=ZrExIWx6wU0"
      },
      {
        "id": "b빚투-청산-0624",
        "date": "2026-06-24",
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/27 토·휴장)",
      "tag": "주말 휴장·거래없음·점검전용",
      "dir": "→",
      "text": "🚫 KR·US 둘 다 휴장 — 거래 없음·예약 후보 없음. 주말 폰창(09:00~20:50)은 점검 전용. 시세 = 6/26 종가 프로즌(코스피 8,411 -5.81%·SOX -5.29%). 6/26 데드캣=메모리 쏠림 차익실현+외인·기관 동반투매(-8.4조)=수급 충격(펀더 무손상). 신규명분 0=전량 홀딩·관망. AAPL 정수 1주 강세 지정가 트림→GOOGL 베이킹(미집행)만 검토. 주말엔 외신·6/29 호남 발표 사전 브리핑·SK하이닉스 ADR(7/10) 일정 모니터."
    },
    {
      "horizon": "다음 거래일 (6/29 월)",
      "tag": "호남 반도체 발표",
      "dir": "→",
      "text": "6/29 이재명 대통령 주재 민관합동회의 — 삼성·SK하이닉스 광주·전남 전공정 팹 + 삼성 충남 AI DC 공식화 전망(총 400조대). 전력·용수·소부장 수혜(두산E·원익IPS) 모멘텀이나 발표≠착공 → 착공·발주 전 추격금지(원익IPS). 데드캣 첫 반등 추격금지(경제사냥꾼). 평일 폰창 17:30~ 당일 대응 가능. 외인 순매수 전환 여부가 강세복귀 스위치."
    },
    {
      "horizon": "이번주 (6/29~7/4)",
      "tag": "NPS 리밸·7월 진입",
      "dir": "→",
      "text": "★외인 순매수 재전환(강세복귀 스위치)+환율 1,500 꺾임이 키. ⚠️7/1경 NPS 국내 리밸런싱 재개=대형주 기계매도(삼성·하닉 매물집중)+빚투 38조 레버리지. 7/3 美 6월 고용(오버나이트). 6/29 호남 발표 소화. 안전핀 7,500(버퍼 +12.1%)·2차 8,000(+5.1% 근접·물타기 금지). 관망 우위."
    },
    {
      "horizon": "이번달~7월",
      "tag": "메모리 3성적표·실적시즌",
      "dir": "→",
      "text": "메모리 정점 판정 = 7월 3성적표(7/7경 삼성 잠정·7/16경 TSMC·7/29 SK하이닉스+美빅테크 capex). 전부 폰창 밖 → 예약 베이킹 필수. 3차 트랜치(META·AVGO) FOMC 매파로 동결(재개=비둘기/META 7/29/외인 복귀). 7/10 SK하이닉스 ADR(SKHY). 7/29 META·7/30 AAPL FY Q3·PCE. 버리 GPU 감가상각 회계논란(META·MSFT·GOOGL·ORCL 감시)."
    }
  ],
  "index_forecast": [
    {
      ...
      "high": 8800,
      "dir": "↘",
      "confidence": "확정(6/26 종가)",
      "note": "🔴 6/26 -5.81%(8,411.21·-519p) 급락 확정 — 장중 -8%대 8,100선 서킷브레이커(올해5번째) 후 회복. 어제 +5.42% 반도체 랠리 전량 반납. 외인 -4.6조(6일째)+기관 -3.8조 동반투매(-8.4조)·개인 +8.2조 흡수. 외인 순매수 재전환 전까지 데드캣 경계·하단 시험. 안전핀 7,500 버퍼 +12.1%(미발동)·2차 8,000(+5.1% 근접·물타기 금지). 첫 반등 추격금지(데드캣)."
    },
    {
      "name": "나스닥",
      "ref": 25358.6,
      ...
      "high": 26200,
      "dir": "→",
      "confidence": "확정(6/25 최종종가)",
      "note": "6/25 최종 -0.46%(AAPL -6.15% 맥북·아이패드 가격인상=메모리 원가직격 견인·MSFT -3.45%·ORCL -3.22% AI/capex 약세) vs MU +15.81% 차별화. PCE 코어 3.4%(3년 최고·소폭매파)로 고듀레이션 빅테크 역풍. 다우 +0.14% 밸류 로테이션."
    },
    {
      "name": "S&P500",
      "ref": 7357.49,
      ...
      "dir": "→",
      "confidence": "확정(6/25 최종종가)",
      "note": "6/25 최종 보합(-0.01%). MU 비트 호재 vs AAPL·빅테크 약세 상쇄, 다우 밸류 강세로 지수 방어. 코어 PCE 3.4% 소폭상회=노컷 매파 유지·9월 인상 ~68%."
    },
    {
      "name": "필라델피아반도체",
      "ref": 13940.87,
      ...
      "dir": "↗",
      "confidence": "확정(6/25 최종종가)",
      "note": "6/25 최종 +3.59% — MU +15.81%($1,213·52주 고가) 독주 견인·STM +4.23%. 목표가 일제 상향(Susquehanna $2,000·GS Neutral $1,100 경계). 단 외인 수급·시클리컬 정점 논쟁이 상단 변수."
    }
  ],
  "tasks": {
    "today": [
      {
        "id": "t-0627-1",
        "text": "🚫 주말(토) 휴장 = 거래 없음·예약 후보 없음. 폰창은 점검 전용. 보유 16 전량 홀딩·신규 0. 강세복귀 스위치(외인 순매수 전환) 미점등 → 6/29(월)부터 외인 플로우 재확인. 2차 8,000(+5.1% 근접)·안전핀 7,500(+12.1%) 물타기 금지.",
        "done": false
      },
      {
        "id": "t-0627-2",
        "text": "🍎 AAPL 트림 베이킹(자동 아님·정훈 결정): 6/26 +3.14%($283.78·원가比 +10.4%) 반등=트림 창. 정수 1주 강세 지정가 사다리($290·$305·$312)→GOOGL 재배치, 1주+분수 글라스 콜옵션 유지. -6% 딥 투매 금지. 7/30 FY Q3 재판단.",
        "done": false
      },
      {
        "id": "t-0627-3",
        "text": "🗓️ 6/29(월) 호남 반도체 발표(400조대)·데드캣 첫반등 추격금지. 7월 3성적표(7/7 삼성·7/16 TSMC·7/29 하닉)+NPS 리밸(7/1) 폰창 밖 → 예약 베이킹 준비.",
        "done": false
      }
    ],
    "week": [
  ...
  "orders": [
    {
      ...
      "amount_usd": 308,
      "date": "2026-06-28",
      "note": "[지정가 오더북] 조건 = AAPL $305 회복. 충족 시 정수 1주 $308 지정가(보수적 $300)로 20:50 전 예약→22:30 자동집행. ⚠️사다리 분할($290·$305·$312)은 분수주=시장가 갭노출이라 회피 → 정수 1주 단일 지정가 1방이 정석. 매도분→GOOGL 소수점 적립(MANGOS 'G'+Anthropic 우회로·재배치 1순위). 미회복 시 7/30 FY Q3까지 보류. 잔여 1주+분수(0.022472)=글라스(2027말)·피지컬AI 콜옵션 유지(전량청산 금지). 13F 버크셔 애플 -74%+알파벳 신규편입 정합. portfolio.json 미변경(미집행)."
    },
    {
      "id": "o-googl-rebal-1",
      ...
      "amount_usd": 300,
      "date": "2026-06-28",
      "note": "[지정가 오더북] $330 이하 눌림서 AAPL 트림 매도대금으로 소수점 적립(시장가). MANGOS 'G'+Anthropic 이중노출·버크셔 신규편입처('Great Pivot')·섹터 최선방(컨센 $432.83·+28%). 트림 체결과 연동."
    },
    {
      "id": "o-ktg-1",
      ...
      "amount_krw": 165000,
      "date": "2026-06-28",
      "note": "[경제사냥꾼 셋업·지정가 오더북] 165,000원 이하 눌림서 신규편입 정수 1주 지정가 검토(현 167,400·−1.4% 근접). 조건 2/3 met(외인 51.24%·해외궐련 +56% 충족, 가격존 미도달). 편입 전 /stock-deepdive 권장. AI 쏠림장 디펜시브 분산."
    },
    {
      "id": "o-naver-1",
      "label": "NAVER",
