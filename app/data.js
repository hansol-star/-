...
window.APP_DATA = {
  "generated_at": "2026-06-30 09:54 KST",
  "as_of": "2026-06-30 화 오후 집행지시서(v35 exec) — 국장 종가 확정: 코스피 8,476.48(+0.97%·장중 8,626 갭업 외인 -3.79조 매물에 되돌림)·외인 8거래일째 매도. 폰창 A/B블록 전량 관망. 별점·스코어 v34 유지",
  "source_report": "docs/reports/report_v35_exec_2026-06-30.md",
  "offline": false,
  "fx": {
    "usdkrw": 1550.9
  },
  "totals": {
    "assets_krw": 8091901,
    "stocks_value_krw": 7467130,
    "cash_krw": 624771,
    "day_change_krw": 83737,
    "day_change_pct": 1.13,
    "total_pnl_krw": 188020,
    "total_pnl_pct": 2.58
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "_updated_note": "v35 2026-06-30: 간밤 SOX 풀반전 방향적중, 트리플확인 대기",
    "scorecard": {
      "buckets": {
        "정확": 32,
        "근사": 24,
  ...
  "orders": [
    {
      ...
      "amount_usd": 308,
      "date": "2026-06-28",
      "note": "[지정가 오더북·6/30 점검] AAPL $281.74 = 조건 $305 대비 −7.6% 미도달 → 미발동(정상). 로테이션 소외·간밤 −0.72%. 조건=$305 회복 시 정수1주 $308 지정가 20:50 전 예약→GOOGL 재배치. 미회복 시 7/30 FY Q3 보류."
    },
    {
      "id": "o-googl-rebal-1",
      ...
      "amount_usd": 300,
      "date": "2026-06-28",
      "note": "[지정가 오더북·6/30] GOOGL $353.65($330 +7% 위)·간밤 +4.82% 다우데뷔·버크셔 $10B 앵커=포트 최강. $330 이하 눌림서 AAPL 트림 대금으로 소수점 적립. 트림 미발동→재배치도 대기. 컨센 $406~493."
    },
    {
      "id": "o-ktg-1",
