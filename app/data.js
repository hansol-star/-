...
window.APP_DATA = {
  "generated_at": "2026-06-26 08:42 KST",
  ...
  "totals": {
    "assets_krw": 7925205,
    "stocks_value_krw": 7300434,
    "cash_krw": 624771,
    "day_change_krw": -209705,
    "day_change_pct": -2.79,
    "total_pnl_krw": 21325,
    "total_pnl_pct": 0.29
  },
  ...
  "hunter": {
    ...
    "updated": "2026-06-26",
    "source": "docs/reports/report_v32_2026-06-26.md",
    ...
    "headline": "★메모리 슈퍼사이클이 양날 — MU 6/25 +15.81%($1,213·52주 고가)엔 로켓연료, 같은 메모리 원가 폭등이 AAPL(-6.15%·맥북·아이패드 가격인상)엔 직격. 美 SOX +3.59% vs 나스닥 -0.46% split 심화. 국장 +5.42%(8,930)이나 외인 5일 연속 순매도(기관 단독)=데드캣 경계. PCE 코어 3.4%(3년 최고·소폭 매파)로 9월 인상 ~68% 유지. 경제사냥꾼 6/25 신규: 7월 부동산 세제=코스피 자금유도(매크로 보강·수치 미확인)·바이오 랠리론(미보유)·삼성전자우 90조 자사주 1개월내 공시 예고(삼성 트래킹).",
    "latest_videos": [
      {
        "id": "7월-부동산-세제-0625",
        "date": "2026-06-25",
  ...
  "outlook": [
    ...
    },
    {
      ...
      "tag": "호남 반도체 발표",
      "dir": "→",
      "text": "6/29 이재명 대통령 주재 민관합동회의 — 삼성·SK하이닉스 광주·전남 전공정 팹 + 삼성 충남 AI DC 공식화 전망(총 400조대). 전력·용수·소부장 수혜(두산E·원익IPS) 모멘텀이나 발표≠착공 → 착공·발주 전 추격금지(원익IPS). 발표 전후 변동성 주목. 주말(토·일) 폰 09:00~20:50 가용·美 휴장."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간 마무리",
