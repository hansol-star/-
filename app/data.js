...
window.APP_DATA = {
  "generated_at": "2026-06-22 00:25 KST",
  "as_of": "KR 6/22 개장 잠정 / US 6/18 종가 (6/19 준틴스+주말 → 간밤 美 세션 없음, 오늘밤 22:30 재개=선물 하락출발 · v25)",
  "source_report": "docs/reports/report_v25_2026-06-22.md (v25)",
  "offline": false,
  "fx": {
    "usdkrw": 1530.6
  },
  "totals": {
    "assets_krw": 8497264,
    "stocks_value_krw": 7872493,
    "cash_krw": 624771,
    "day_change_krw": 74537,
    "day_change_pct": 0.96,
    "total_pnl_krw": 571567,
    "total_pnl_pct": 7.83
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "channel_note": "테마·방향성은 빠르고 유용(로봇·AI전력·종전 등 선제 포착). 단 구체 수치는 자막오류·과장 잦음 → 방향성은 채택하되 숫자는 교차검증. 트랙레코드 개선세. ✅6/22 신규 7편 = tv 클라이언트로 자막 전량 확보(v24 봇차단 개선).",
    "headline": "6/22(v25) 신규 7편 자막 전량 확보. ①삼성=마이클 버리 매수논지·1Q 영익 57.2조[검증] ②앤트로픽 상장 수혜 아마존·브로드컴(AVGO)·SKT[검증, SKT지분 정정] ③SpaceX+테슬라 합병설 NYT[검증, $4조→$3.4조 정정] ④트럼프 美정부 지분 인텔·고려아연[검증](삼성·하이닉스 다음 후보는 미확인) ⑤쿠바 다음타깃[미확인 예단] ⑥KT&G[검증·정확도 최고]=신규 워치 후보 ⑦LG전자 자사주 2조→2,000억(10배 과장 정정). 정확도 KT&G 최고, 과장패턴(③⑦ 단위)·예단(④⑤) 재확인.",
    "latest_videos": [
      {
  ...
  "flows": {
    ...
    "series": [
      ...
      },
      {
        ...
        "inst": null,
        "indiv": null,
        "note": "장중 미확정(데이터센터 IP·장초반)·마감 후 확정. 외인 재유입=강세 분수령. 추측 금지(null)"
      }
    ]
  },
  "reports": [
  ...
  "outlook": [
    {
      ...
      "tag": "관망",
      "dir": "→",
      "text": "거래창은 열렸지만 사실상 관망 — 3중 불확실(①외인 재유입 장중 미확정 ②오늘밤 美 재개 갭, 선물 −0.7~−1.2% 하락출발 ③이란 재긴장). 폰창 17:30~20:50: 국내 시간외=NAVER 정수1주(외인확인 시만), 미국=신규진입 보류. 추격금지·코어 홀딩."
    },
    {
      "horizon": "내일 (6/23 화)",
      "tag": "베이킹·MSCI",
      "dir": "→",
      "text": "새벽 MSCI 연례 시장분류 발표(한국 선진국 관찰대상, 선반영 해소 변동성). ★저녁 폰창에서 MU 절반차익(0.02주) 사전 베이킹 — 6/25 새벽 실적 폰 미가용 대비."
    },
    {
      "horizon": "이번주 (6/22~26)",
      "tag": "이벤트 주간",
      "dir": "→",
      "text": "반도체 호황 '시험 주간'. 6/25(목) 더블 분수령 = MU 실적(새벽 ~05:00)+美 5월 PCE(밤 21:30). 둘 다 야간/새벽 폰 미가용 → 6/24 20:50 전 예약 베이킹. 오늘밤 美 재개 갭 소화가 주초 변수."
    },
    {
      "horizon": "이번달 (6월 잔여)",
      "tag": "관망·재개조건",
  ...
  "index_forecast": [
    {
      ...
      "high": 9300,
      "dir": "→",
      "note": "6/22 외인 재유입이 분수령(장중 미확정). 복귀 시 9,300 시도, 재차 이탈 시 8,900 눌림. 오늘밤 美 갭도 변수."
    },
    {
      "name": "나스닥",
      "ref": 26517.93,
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0622-1",
        "text": "6/22 국장 마감 후 외인 코스피 순매수/매도 확정 확인 → 재유입=강세 / 재차 매도=신중 경보",
        "done": false
      },
      {
        "id": "t-0622-2",
        "text": "폰창(17:30~18:00 시간외): NAVER 정수 1주(≈229,500원 지정가)는 외인 재유입 확인 시에만, 미확정이면 보류",
        "done": false
      },
      {
        "id": "t-0622-3",
        "text": "오늘밤 22:30 美 재개 = 신규 진입 보류(선물 −1.2%·누적 갭·룰7). 3차 트랜치 동결 유지",
        "done": false
      },
      {
        "id": "t-0622-4",
        "text": "SK하이닉스 美 SEC ADR 승인 헤드라인 주시(6월 넷째주)",
        "done": false
      }
    ],
    "week": [
