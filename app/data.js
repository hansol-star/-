...
window.APP_DATA = {
  "generated_at": "2026-06-22 11:54 KST",
  "as_of": "KR 6/22 종가 확정 / US 6/18 종가(오늘밤 22:30 재개=선물 약보합) · v26 장마감 후 풀 재분석",
  "source_report": "docs/reports/report_v26_2026-06-22.md",
  "offline": false,
  "fx": {
    "usdkrw": 1537.92
  },
  "totals": {
    "assets_krw": 8520950,
    "stocks_value_krw": 7896179,
    "cash_krw": 624771,
    "day_change_krw": 69843,
    "day_change_pct": 0.89,
    "total_pnl_krw": 595252,
    "total_pnl_pct": 8.15
  },
  "safety": {
    "pin": 7500,
  ...
  "outlook": [
    {
      ...
      "tag": "관망·집행0",
      "dir": "→",
      "text": "집행 0 확정. 코스피 9,114.55 종가 사상최고(첫 9,100 돌파)지만 외인 −2.55조 2일연속 순매도=재유입 분수령 실패(신중). 개인 +2.12조·기관 흡수. SK하이닉스 +5.61% 시총 단일1위 등극(우선주합산 삼성 유지). NAVER 222k 매수존 이탈→1차 보류 확정. 오늘밤 미국 재개 선물 약보합(추격금지)."
    },
    {
      "horizon": "내일 (6/23 화)",
      "tag": "분수령·MSCI",
      "dir": "→",
      "text": "새벽 MSCI 시장분류 발표=선진국 편입 실패 전망(차기 2028 순연, 외인 단기 실망재료). ★저녁 폰창 MU 절반차익(0.02주) 사전 베이킹 검토 — 6/25 새벽 실적 폰 미가용 대비(6/24 저녁도 가능). 오늘 분수령 실패 → 외인 재유입 전환 여부 재확인이 추세 판가름."
    },
    {
      "horizon": "이번주 (6/22~26)",
      "tag": "이벤트 주간",
  ...
  "index_forecast": [
    ...
    },
    {
      ...
      "high": 27000,
      "dir": "→",
      "note": "오늘밤 재개 선물 약보합(−0.1%·나스닥100 보합, 아침 −1.2% 추정 정정). MU 6/25 실적·PCE가 방향 결정. SOX 5월고점 −6.8% 조정."
    },
    {
      "name": "S&P500",
      "ref": 7500.58,
      ...
      "high": 7600,
      "dir": "→",
      "note": "재개 선물 약보합·VIX 17.36. 美-이란 60일 로드맵으로 갭다운 회피. 6/25 PCE 분수령."
    },
    {
      "name": "필라델피아반도체",
      "ref": 14341.78,
      ...
      "high": 15000,
      "dir": "→",
      "note": "6/18 +6.42% 신고가 후 MU 실적 앞 차익실현 압력. MU 6/25 실적이 섹터 분수령. good-news-priced-in 위험."
    }
  ],
  "tasks": {
    "today": [
