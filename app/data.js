...
window.APP_DATA = {
  "generated_at": "2026-06-21 06:42 KST",
  "as_of": "KR 6/19 마감 / US 6/18 종가 (6/20 토·6/21 일 주말 휴장 프로즌 · v23 0~100 정량 스코어 16종목 적용)",
  "source_report": "docs/reports/report_v23_2026-06-21.md (v23)",
  "offline": false,
  "fx": {
    "usdkrw": 1529.89
  },
  ...
  "hunter": {
    ...
    "headline": "6/20 추가 신규 4편 반영(쇼츠 자막 전량 확보). ★보유 직결: LG전자(데이터센터 냉각·로봇 액추에이터 — 7/23 실적 검증 구간)·AVGO(엔트로픽 IPO 프록시 = 아마존·브로드컴·SKT). 테마 시야: 2차전지 ESS(AI 전력저장)·고려아연 트럼프 핵심광물. 다음주(6/22~26)는 여전히 MU 6/25·美 PCE가 분수령.",
    "latest_videos": [
      {
  ...
  "outlook": [
    {
      ...
      "tag": "휴장",
      "dir": "→",
      "text": "KR·US 전 시장 주말 휴장. 시세 프로즌. 6/22(월) 외인 재유입 시나리오·MU 6/25 실적 베이킹 준비만."
    },
    {
      "horizon": "월요일 (6/22)",
      "tag": "분수령",
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0621-1",
        "text": "주말 휴장 — 6/22 외인 재유입 시나리오·대응 룰 정리",
        "done": false
      },
      {
        "id": "t-0621-2",
        "text": "holdings_outlook.md 별점·매수존 재확인 (변화 없으면 유지)",
        "done": false
      }
    ],
    "week": [
