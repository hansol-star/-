...
window.APP_DATA = {
  "generated_at": "2026-06-30 00:23 KST",
  "as_of": "2026-06-30 화 아침 풀브리핑(v35) — 간밤 美 6/29 풀마감 리스크온 대반전(SOX +3.83%·MU 풀반전)·국장 개장 전. 별점·스코어 v34 유지(FMP 미갱신)",
  "source_report": "docs/reports/report_v35_2026-06-30.md",
  "offline": false,
  "fx": {
    "usdkrw": 1543.18
  },
  "totals": {
    "assets_krw": 8063771,
    "stocks_value_krw": 7439000,
    "cash_krw": 624771,
    "day_change_krw": 84220,
    "day_change_pct": 1.15,
    "total_pnl_krw": 159890,
    "total_pnl_pct": 2.2
  },
  "safety": {
    "pin": 7500,
  ...
  "hunter": {
    ...
    "updated": "2026-06-30",
    "source": "docs/reports/report_v33_2026-06-27.md",
    "channel_note": "테마·방향성은 빠르고 유용(로봇·AI전력·종전 등 선제 포착). 단 구체 수치는 자막오류·과장 잦음 → 방향성은 채택하되 숫자는 교차검증. 트랙레코드 개선세. ✅봇차단 없음·yt-dlp 최신(2026.6.9)·자막 정상. 6/25 야간이후 신규 3편 = 보유16 직격정보는 약함(관망 강화). 패턴 반복: 방향성 양호·구체수치 과장(삼성전자우 괴리율 34%→실제 32% 정정).",
    "headline": "6/30 신규 영상 없음. 6/29 5편 핵심보강 — 선행PER 삼성 6.48·하닉 6.98·MU 11.2배 [검증](FN가이드·v34 미확인 승격)·애플 가격인상 [검증](자막오류 1건 정정)·환율 24시간 7/6 [검증]. 채널 \"실적이 바닥\" 논지가 간밤 SOX +3.83% 풀반전으로 방향 적중. 트래킹=7/1수출·7/2고용·7/7삼성 트리플 확인",
    "setups": [
      {
        "id": "setup-메모리코어-0629",
        "ticker": "005930.KS",
      ...
      },
      {
        ...
        "conditions": [
          {
            "text": "외인 코스피 순매수 1~2일 전환",
            "met": false
          },
          {
            "text": "원/달러 1,500선 하향 꺾임(현 1,542)",
            "met": false
          },
          {
            "text": "코스피 8,000(2차)·7,500(안전핀) 지지(현 8,395)",
            "met": true
          }
        ],
      ...
      },
      {
        ...
        "thesis": "반도체팹 증설=전력기기·변압기·케이블 병목설비 선투입. 호남 2000조 발표(검증).",
        "conditions": [
          {
            "text": "발표 공식화(6/29)",
            "met": true
          ...
          {
            "text": "후속 구체화(6/30 최태원 광주·7/2 이재용 아산)",
            "met": false
          },
          {
            "text": "테마 급등 소화(추격금지·룰3)",
            "met": false
          }
        ],
        "action": "LG전자·두산E 보유분 연결. 추격금지·후속 구체화 후.",
        "status": "추적중"
      },
      {
        "id": "setup-ktg-0626",
    ...
    "latest_videos": [
      {
        ...
        "title": "(신규 영상 없음)",
        "tag": "미확인",
        "note": "6/30 업로드 신규영상 미발견(6/29 5편이 최신). yt-dlp 정상·봇차단 없음"
      },
      {
        "date": "2026-06-29",
        "title": "이번주 중요 투자 포인트",
    ...
    "track_record": [
      {
        "date": "2026-06-30",
        "verdict": "방향적중",
        "note": "6/30 신규영상 없음. 6/29 5편 보강 수치 매우정확(애플 자막오류 1건만 정정). 채널 \"옥석가리기 후 메모리 생존\" 논지가 간밤 SOX +3.83%·MU 풀반전으로 하루만에 실현. 선행PER 6.48/6.98/11.2배 [검증] 승격. 단 PM 견제=갭업 추격금지·외인전환까지 신규동결"
      },
      {
        "date": "2026-06-29",
        "verdict": "적중",
  ...
  "outlook": [
    {
      "horizon": "오늘 (6/30 화)",
      "tag": "美 반등 동조 vs 외인·NPS 캡",
      "dir": "↗",
      "text": "간밤 美 리스크온 대반전(SOX +3.83%·MU 풀반전·TSLA +8.46%·GOOGL 다우데뷔)에 국장 삼성(−4.76% 과매도)·하닉 갭업 시도 여지. 단 외인 −8.3조 6일째+환율 1,543+7/1 NPS 매물벽이 상단 캡. 외인이 갭업에 매물 내놓는지(되돌림)가 진위 가늠자. 추격금지(룰3)·보유 홀딩·신규 0. 폰창 신규예약 없음·두산E 10만 돌파만 주시."
    },
    {
      "horizon": "내일 (7/1 수)",
      "tag": "NPS 재개+韓수출 분수령",
  ...
  "index_forecast": [
    {
      ...
      "high": 8700,
      "dir": "↗",
      "confidence": "추정(개장전·6/29 종가 기준)",
      "note": "간밤 美 SOX 풀반전 동조 갭업 시도 여지(삼성 과매도 반등). 단 외인 −8.3조 6일째+7/1 NPS 매물벽이 상단 캡. 외인 전환 전까지 데드캣 경계. 안전핀 7,500(+11.9%)·2차 8,000(+4.9% 근접·물타기 금지)."
    },
    {
      "name": "코스닥",
      "ref": 920.57,
  ...
  "tasks": {
    "today": [
      {
        "id": "t-0630-1",
        "text": "간밤 美 풀반전 확인(SOX +3.83%·MU 풀반전·TSLA +8.46%·GOOGL 다우데뷔) → 보유 16 전량 홀딩·신규 0. 美 갭업에 국장 동조해도 추격금지(룰3).",
        "done": false
      },
      {
        "id": "t-0630-2",
        "text": "오늘 17:30 폰창 신규예약 없음(전 조건 미충족): AAPL $305·삼성 295~305k·두산E 10만·KT&G 165k 전부 미도달. 두산E 10만 돌파+소화만 주시(정수1주·추격금지).",
        "done": false
      },
      {
        "id": "t-0630-3",
        "text": "★외인 7일째 매도 멈추는지 개장 후 확인 = 강세복귀 스위치 최우선. 美 갭업에 외인이 순매수 전환하면 삼성 1차 트랜치 명분, 다시 던지면 데드캣. 7/1 NPS 매물벽 D-1.",
        "done": false
      },
      {
        "id": "t-0630-4",
        "text": "경제사냥꾼 6/29 5편 보강: 선행PER 6.48/6.98/11.2배 [검증]·애플 가격인상 [검증]·환율 24시간 7/6. 트리플 확인(7/1수출·7/2고용·7/7삼성) 트래킹. 채널 단독 매수 금지.",
        "done": false
      }
    ],
    "week": [
