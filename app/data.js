...
window.APP_DATA = {
  "generated_at": "2026-06-24 10:26 KST",
  ...
  "totals": {
    "assets_krw": 8218810,
    "stocks_value_krw": 7594039,
    "cash_krw": 624771,
    "day_change_krw": -43104,
    "day_change_pct": -0.56,
    "total_pnl_krw": 293113,
    "total_pnl_pct": 4.01
  },
  "safety": {
    "pin": 7500,
  ...
  "tasks": {
    "today": [
      ...
      {
        "id": "t-0623-2",
        "text": "✅6/24 코스피 8,471(+3.26%) 8,000 사수 확인. 외인 추가투매에도 V반등 — 추격금지(삼성 +9.84% 이탈)·줍줍 보류 유지",
        "done": true
      },
      {
        "id": "t-0623-3",
        "text": "✅MU 절반차익 예약 완료(6/24 18:40, 0.019999주 시장가, 집행 22:31). 빅테크 3차 트랜치 동결 유지(FOMC 매파+BofA 3회 인상설+AI capex 회의)",
        "done": true
      },
      {
        "id": "t-0623-4",
    ...
    "week": [
      {
        "id": "t-w-1",
        "text": "✅6/24 새벽 MSCI 시장분류 확인 완료 — 한국 선진국 관찰대상 미등재(컨센 부합). 외인 반응 점검 계속",
        "done": true
      },
      {
        "id": "t-w-2",
        "text": "✅MU 절반차익 예약 완료(6/24 18:40, 0.019999주 시장가, 집행 22:31 US개장) — 6/25 새벽 실적 직전 베이킹",
        "done": true
      },
      {
        "id": "t-w-3",
  ...
  "orders": [
    ...
    },
    {
      ...
      "amount_krw": 0,
      "date": "2026-06-24",
      "note": "✅예약 완료(6/24 18:40, 폰창). 0.019999주 소수점=시장가, 집행 22:31 US개장(6/25 새벽 실적 직전). +40%대 정점·집중도 헤지. 분수주는 시장가 전용이라 야간 갭다운 시 단가 불리 가능성 인지하고 절반만. Needham $1,550·Bernstein $1,300 상향. 체결 시 portfolio.json 보유수량·master.md 갱신 예정."
    }
  ],
