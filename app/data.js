...
window.APP_DATA = {
  "generated_at": "2026-06-20 13:07 KST",
  ...
  "hunter": {
    ...
    "headline": "다음주(6/22~26) = 반도체 호황 진위 '시험 주간'. 분수령 6/25 새벽 MU 실적 + 밤 美 PCE. MU 도이체방크 $1,500 상향(검증)·6/23 저녁 절반차익 베이킹과 정합. 신규=제주반도체(온디바이스 AI LPDDR, 하이닉스 생태계)",
    "latest_videos": [
      {
        "date": "2026-06-20",
