...
window.APP_DATA = {
  "generated_at": "2026-06-24 14:11 KST",
  "as_of": "2026-06-24 23:05 KST (야간점검·미장 개장초 실시간)",
  ...
  "totals": {
    "assets_krw": 8208482,
    "stocks_value_krw": 7583711,
    "cash_krw": 624771,
    "day_change_krw": 68853,
    "day_change_pct": 0.92,
    "total_pnl_krw": 282784,
    "total_pnl_pct": 3.87
  },
  "safety": {
    "pin": 7500,
  ...
  "holdings": [
    ...
    },
    {
      ...
      "comment": "+40.4% 평가익($1,051.77, 고점 +61.7%서 축소). 회사 가이드 매출 $33.5B·GM~81%·EPS$19.15 < Street 컨센($34.66B·$19.95)=비트 기대 선반영. 컨센 평균TP $1,022(현재가 −2.7% 괴리)=실적이 분기점. 골드만 Neutral ~$900 vs UBS $1,625·Citi $1,200·MS $1,050. GM 81% 유지가 핵심. 6/25 새벽 실적(폰 미가용) → 6/24 저녁 폰창서 절반(0.02주) 시장가 예약. ⚠️실적 전 −13.18% 급락으로 '고점확보' 명분 약화 → 집중도 완화 목적이면 결과무관 절반차익, 단가 불리하면 보고판단 택1.",
      "issues": [
        {
          "date": "2026-06-24",
          "tag": "검증",
  ...
  "hunter": {
    ...
    "updated": "2026-06-24",
    "source": "docs/reports/report_v30_2026-06-24.md",
    ...
    "headline": "🔴검은화요일(6/23 −9.99% 서킷) 폭락원인 = 3대 악재 동시: ⓐ美 AI 인재이탈(Shazeer→OpenAI·Jumper→Anthropic, 알파벳 6/22 −7%·시총 $250B 증발)+ⓑ연준 매파(BofA 9·10·12월 3회 인상→4.50%)+ⓒ미실현이익 과세 논의 → 반도체 주도주 차익실현. 폭락원인 쇼츠 조회 311K(압도적 1위). MU 실적(6/25 새벽)=메모리 분수령, 컨센 매출 $35.59B·EPS $20.57·목표 니덤$1,550/번스타인$1,300/UBS$1,625·골드만 중립. SPCX MSCI ESG CCC·$200억 채권·상장후 최저.",
    "latest_videos": [
      {
  ...
  "outlook": [
    {
      ...
      "tag": "🔄데드캣·야간점검",
      "dir": "↗",
      "text": "[야간점검 23:05] 국장 마감 코스피 +3.26%(8,471.02)·코스닥 +2.00%(909.31) 데드캣 반등(외인 −4.66~5.16조 추가투매, 개인+기관 양매수 견인·삼성 +9.84% 지수편중). 미장 개장초(22:30~) 어제 폭락 대비 진정·혼조: MU $1,042(−0.91% 실적직전 안정)·GOOGL +1.15%·ORCL −2.09%·나머지 ±0.5% 보합·FX 1,544.65. ★예약점검: MU 절반차익(0.02주 시장가) 22:30 집행시각 경과·체결추정이나 무인세션 미확인→정훈 토스 확인 필요. 보유 16종목 수량/평단 변동 0·현금 624,771원 유지."
    },
    {
      "horizon": "내일 (6/25 목)",
      "tag": "더블분수령·폰미가용",
      "dir": "→",
      "text": "★새벽 ~05:30 MU 실적(美 6/24 장마감 후) = 메모리 분수령(GM81%·HBM 5년계약 관건, 옵션 ±11~17% 양방향 폭탄) + ★밤 21:30 美 5월 코어 PCE. 둘 다 야간·폰 미가용 → 6/24 20:50 전 예약 베이킹만. MU 비트=메모리 반등 트리거 / sell-the-news=메모리4종(삼성·하닉·원익) 동반약세. 컨센 매출 $34.66~35.59B·EPS $19.95~20.57."
    },
    {
      "horizon": "이번주 (6/23~27)",
      "tag": "이벤트 주간",
      "dir": "→",
      "text": "분수령 = 외인 매도 진정(오늘)·MU 실적(6/25 새벽)·美 PCE(6/25 밤)·코스피 8,000 사수. 검은화요일이 '1일천하'(6/18 FOMC 전례)냐 추세전환이냐가 핵심 — 외인 순매수 재전환이 강세 복귀 스위치. 빅테크 AI capex ROI 회의론(하이퍼스케일러 1주 −$1.35T)이 레짐전환이냐 밸류 되돌림이냐. 고환율 1,533·美2Y 4.2%·9월 인상 68% 역풍."
    },
    {
      "horizon": "이번달~7월",
      "tag": "관망·7월리스크",
      "dir": "→",
      "text": "3차 트랜치(META·AVGO) FOMC 매파로 보류 중. 재개 조건 = 비둘기 전환 / META 7/29 실적 / 외인 순매수 복귀 중 하나. ⚠️7월 NPS 리밸런싱 = 월 7~8조 기계적 매도(받침대 제거) + 빚투 신용 38조 사상최고 반대매매 리스크. 7/6 원달러 24시간 거래. 7/16 한은 금통위 2.50→2.75% 인상 전망. 안전핀 코스피 7,500(현 8,204, +9.4% 버퍼 반토막)."
    }
  ],
  "index_forecast": [
    {
      ...
      "high": 8700,
      "dir": "↗",
      "note": "🔄6/24 +3.26%(+267.18p·8,471.02) 데드캣 반등(장중 8,080~8,577 496p 롤러코스터). 단 ★외인 −4.66~5.16조 추가 순매도(진정 아님)·개인 +2.63~2.89조·기관 +1.91~2.13조 반발매수가 견인. 삼성 +9.84%(시총1위 탈환) 지수편중. V코스피 95.27 초고변동성. 8,000 사수했으나 외인 순매수 재전환 전까지 추세복귀 단정 금지. 안전핀 7,500 버퍼 +12.9%(미발동)."
    },
    {
      "name": "나스닥",
      "ref": 25587.04,
      ...
      "high": 26300,
      "dir": "→",
      "note": "6/23 −2.21% 최종. AI capex ROI 회의론(하이퍼스케일러 1주 −$1.35T). MU 6/25 실적·PCE가 방향 결정. split market(고밸류 SW 직격·캐시카우 방어)."
    },
    {
      "name": "S&P500",
      "ref": 7365.46,
      ...
      "high": 7480,
      "dir": "→",
      "note": "6/23 −1.44% 최종·VIX 20.13. 다우 −0.09%(가치 로테이션 방어) vs 나스닥 −2.21%. 6/25 PCE 분수령."
    },
    {
      "name": "필라델피아반도체",
      "ref": 13482.51,
      ...
      "high": 14400,
      "dir": "→",
      "note": "🔴6/23 −7.87% 단독붕괴(MU −13.18% 실적D-1·NVDA −4.13%·ANET −7.08%). MU 6/25 실적이 섹터 분수령. 비트=반등 트리거 / 미스=±13% 추가 갭다운."
    }
  ],
  "tasks": {
    "today": [
      {
        "id": "t-0624-1",
        "text": "✅확인 완료 — 8,000 사수(8,471) but 외인 −4.66~5.16조 추가 투매로 '진정' 실패 = 데드캣 성격. 폰창 기본값=관망 유지. 패닉셀도 금지(코어 펀더 무손상)",
        "done": true
      },
      {
        "id": "t-0624-2",
      ...
      {
        "id": "t-0624-3",
        "text": "✅조건부 정수 1주 = 불성립·관망 확정. 삼성 +9.84%로 매수존(295~305k) 위 +11.6% 이탈=추격금지, NAVER 199,400 존아래나 외인투매+정리후보 보류. '외인 진정' 전제 실패. 신규매수 안 함",
        "done": true
      },
      {
        "id": "t-0624-4",
    ...
    "week": [
      {
        "id": "t-w-1",
        "text": "✅6/24 새벽 MSCI 확정 = 한국 선진국 관찰대상 재제외(원화 역외환전 제한 미해소). 외인 단기 수급 모멘텀 악재 굳어짐 — 외인 진정 여부 추적",
        "done": true
      },
      {
        "id": "t-w-2",
        "text": "★6/25 새벽 MU 실적(GM81%·HBM 5년계약 관건, 옵션 ±11~17%)+美 5월 코어 PCE(밤 21:30) — 둘 다 야간·폰 미가용, 반응매매 금지·사전 조건부룰만. MU 절반차익 6/24 저녁 베이킹",
        "done": false
      },
      {
        "id": "t-w-3",
        "text": "검은화요일='1일천하'(6/18 FOMC 전례)냐 추세전환이냐 판독 — 외인 순매수 재전환=강세 복귀 스위치. 집중도(메모리/HBM 4종) 동조하락 리스크 점검",
        "done": false
      },
      {
        "id": "t-w-4",
        "text": "안전핀 코스피 7,500 모니터링(현 8,471, 버퍼 +12.9%) + 신용 38조·환율 1,544·9월 연준 인상확률 68% 추적",
        "done": false
      }
    ],
    "month": [
      {
        "id": "t-m-1",
        "text": "⚠️7월 NPS 리밸런싱 재개 리스크 점검 — 국내비중 14.9→20.8% 상향분 최대 55조 매도, 대형주(삼성·SKH) 매물집중 가능 + 빚투 38조",
        "done": false
      },
      {
        "id": "t-m-2",
      ...
      {
        "id": "t-m-3",
        "text": "트림 후보 점검 — AAPL(목표 근접+中리스크 트림1순위) / MU(시클리컬 정점)",
        "done": false
      },
      {
        "id": "t-m-4",
        "text": "KT&G 신규 워치 후보 딥다이브 검토(디펜시브 분산, DS증권 목표 24만)",
        "done": false
      }
    ]
  },
  ...
  "orders": [
    {
      ...
      "amount_krw": 202500,
      "date": "2026-06-24",
      "note": "1차 트랜치 보류 지속. 6/24 종가 199,400원(−1.53%)=매수존(225~235k) 한참 아래지만 ★외인 추가 −4.66~5.16조 투매 지속('외인 진정' 전제 실패)+정리후보=관망 확정. 삼성은 +9.84%로 매수존 위 이탈(추격금지). 강세복귀 스위치=외인 순매수 재전환 확인 전까지 신규매수 보류. 7,500 하회=전면 동결."
    },
    {
      "id": "o-mu-trim-1",
      "label": "MU 절반차익",
      ...
      "date": "2026-06-24",
      "exec_at": "22:30",
      "note": "⚠️22:30 집행시각 경과(현재 23:05)+MU 정상거래($1,042)로 시장가 매도 ★체결추정이나, 무인세션(토스키·스크린샷 없음)이라 확정 불가 → 정훈 토스 앱 확인 필요. 추정 $20.84(≈32,200원·FX1,544.65). 잔여 평단 $749 불변·수량만 절반↓(체결 확정 시 portfolio.json·master.md 갱신). 미체결(취소/거부) 시 6/25새벽 실적 전 재판단. 목적=집중도 헤지(수익극대화 아님)·야간 실적 ±11~17% 꼬리리스크 절반 제거+나머지 절반 업사이드 유지."
    }
  ],
