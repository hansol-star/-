# v16 부록 · 2026-06-17 — 심층분석 ①~④ + 경제사냥꾼 자막 재추출

> v16 본보고서 §8 선택지 4건 전부 심층화(macro·kr-market·semi-ai·power-physical 데스크) + 경제사냥꾼 자막 6건 전량 재확보(research-feed). **투자 자문 아님 — 최종 결정은 정훈.** 시세=6/17(KR)/6/16(US) 기준.
