...
## 실제 스케줄 등록 (Claude Code Routines · cron = UTC, KST−9)

| 루틴 | KST | cron(UTC) | 세션 |
|---|---|---|---|
| R1 영상 프리페치 | 평일 10:00 | `0 1 * * 1-5` | 매 발동 새 세션 |
| R2 메인 보고서 | 평일 16:00 | `0 7 * * 1-5` | 매 발동 새 세션 |
| R3 주말 캘리브 | 토 09:00 | `0 0 * * 6` | 매 발동 새 세션 |
